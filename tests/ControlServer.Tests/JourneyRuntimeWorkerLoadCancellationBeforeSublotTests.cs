...
public sealed class JourneyRuntimeWorkerLoadCancellationBeforeSublotTests
{
    ...
    // ---- After the stop ends, the vehicle takes the next demand (control-server#131) ----------------
    //
    // Whatever ends a stop without its cargo leaving it, the vehicle is free for the next demand
    // afterwards. Driven like AfterAStationTimeoutTheVehicleTakesTheNextDemand...: the stop is ended, a
    // second demand is put in the catalog, and two runtime rounds must dispatch it to the same vehicle
