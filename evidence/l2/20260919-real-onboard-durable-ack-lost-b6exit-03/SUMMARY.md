...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260919T130303523Z` |
...
| 确认丢失的那次装货已完成：会话重回 Ready 之后、卸货等操作员之前，HMI 上从未出现「上次装货操作未完成」（onboard-hmi#124） | PASS | `>= 10 HMI scans, 0 unfinished projections` | `99 scans, 0 seen` |
