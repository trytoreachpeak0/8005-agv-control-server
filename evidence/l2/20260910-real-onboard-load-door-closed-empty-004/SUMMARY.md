...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260910T121128203Z` |
...
| 全程只有一个 attempt，最终 Committed——重开不新建操作 | PASS | `Committed / 37d78b0f-9de1-b75d-be50-ab884c3ea010` | `Committed / 37d78b0f-9de1-b75d-be50-ab884c3ea010` |
| 整趟只发了一份 OperationResult，就是最后成功的那一份 | PASS | `1` | `1` |
| 需求从头到尾没有被判 RecoveryRequired | PASS | `Accepted` | `Accepted` |
| 车载端报文逐条符合 protocol-v0.3.0 的 JSON Schema（真车载端包写进 `ProtocolInbox.RequestJson` 的每一行） | PASS | `退出码 0，校验行数 > 0，未登记违约 0` | `退出码 0：Schema conformance (protocol-v0.3.0): 61 lines, 61 distinct, 11 message types, 0 distinct violations, 0 known; schema compilation 16350 ms.` |
