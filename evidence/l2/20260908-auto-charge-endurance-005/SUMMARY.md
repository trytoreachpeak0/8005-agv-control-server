...
失败原因：Timed out after 120s waiting for: the second journey loaded and left for the gate. Last observed: "AwaitingDepartureSafety"

## 身份

| 项 | 值 |
| --- | --- |
| runId | `20260907T182532969Z` |
| agvId | `AGV-L2-001` |
| controlServerCommit | `2b62ebc8ca03a99ea7ac05b2b1ee7dcdaed07f03` |
| rig | `SyntheticOnboard` |
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260907T182532969Z` |
...
| 充电行程建出并确认了一条 TO_CHARGER 单 | FAIL | `CONFIRMED / 211` | `PENDING_RECONCILIATION / 211` |
| 充电不产生旅程，也不占用需求 | PASS | `1` | `1` |
| 去充电桩的路上不会重复派单 | PASS | `1` | `1` |
| 到桩并确认在充电 | PASS | `Charging / 无阻塞原因` | `Charging /` |
| 充电未达恢复线时新需求被电量政策挡住 | FAIL | `BATTERY_POLICY_NOT_SATISFIED` | `` |
