...
失败原因：Timed out after 90s waiting for: stop 1 has a movement order. Last observed: (nothing)

## 身份

| 项 | 值 |
| --- | --- |
| runId | `20260910T062329836Z` |
| agvId | `AGV-L2-001` |
| batchId | `BATCH-3` |
...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260910T062329836Z` |
