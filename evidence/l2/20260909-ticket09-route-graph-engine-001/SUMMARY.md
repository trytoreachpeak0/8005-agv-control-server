...
| 项 | 值 |
| --- | --- |
| runId | `20260908T074453040Z` |
| agvId | `AGV-L2-001` |
| controlServerCommit | `7b6231bd8b2157ebad47e1348178a0143a771aac` |
| rig | `SyntheticOnboard` |
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260908T074453040Z` |
...
| 设计态读回了三个站点 | PASS | `3` | `3` |
| 运行态周期也跑过（移除集已读回，空是正常答案） | PASS | `(非空)` | `2026-09-08 07:45:00.1353495+00:00` |
