...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260909T154710432Z` |
...
| UIA 录入的 sublot 经真车载端以 KEYBOARD 方式提交到服务端 | PASS | `L2-SUBLOT-20260909T154710432Z / KEYBOARD / L2-OPERATOR` | `L2-SUBLOT-20260909T154710432Z / KEYBOARD / L2-OPERATOR` |
...
| 装载操作提交（Committed），且记的是 UIA 录进去的那个 sublot | PASS | `Committed / L2-SUBLOT-20260909T154710432Z` | `Committed / L2-SUBLOT-20260909T154710432Z` |
