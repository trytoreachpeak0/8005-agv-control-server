...
| 项 | 值 |
| --- | --- |
| runId | `20260919T103624256Z` |
| agvId | `AGV-L2-001` |
| batchId | `batch-2` |
| controlServerCommit | `360669495a71e7265e58ccbf300fbbf6ea171a8b` |
| onboardHmiCommit | `cb6f61ddb38482357f344476874901c91385c74d` |
...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260919T103624256Z` |
...
| 确认丢失的那次装货已完成：会话重回 Ready 之后、卸货等操作员之前，HMI 上从未出现「上次装货操作未完成」（onboard-hmi#124） | PASS | `>= 10 HMI scans, 0 unfinished projections` | `90 scans, 0 seen` |
