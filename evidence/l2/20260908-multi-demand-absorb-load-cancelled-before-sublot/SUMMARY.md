...
| 项 | 值 |
| --- | --- |
| runId | `20260908T053501985Z` |
| agvId | `AGV-L2-001` |
| controlServerCommit | `54d97d096b823d07172c64a2a9318cf08a912ca6` |
| rig | `SyntheticOnboard` |
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260908T053501985Z` |
...
| 车辆调度租约已释放 | PASS | `已释放` | `ReleasedAt=2026-09-08 05:35:11.4087547+00:00` |
| 那条没人回答的条码录入请求被结算了 | PASS | `已结算` | `AcknowledgedAt=2026-09-08 05:35:11.4087547+00:00` |
| 按业务键写下了永久取消抑制 | PASS | `1 条 / CANCELLED_BY_OPERATOR` | `1 条 / CANCELLED_BY_OPERATOR / key=L2-SUBLOT-20260908T053501985Z-A\|WIRE_TO_GATE` |
