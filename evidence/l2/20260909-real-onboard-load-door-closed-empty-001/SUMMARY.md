...
失败原因：Timed out after 60s waiting for: the onboard re-pulsed the unlock for round 2. Last observed: 2

## 身份

| 项 | 值 |
| --- | --- |
| runId | `20260909T094024133Z` |
| agvId | `AGV-L2-001` |
...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260909T094024133Z` |
...
| 第 1 轮：重开脉冲真的走到了 IO——门又弹开了，不只是发了条消息 | PASS | `OPEN` | `OPEN` |
