...
| 项 | 值 |
| --- | --- |
| runId | `20260920T194031027Z` |
| agvId | `AGV-L2-001` |
| batchId | `unspecified` |
| controlServerCommit | `a34495b609bb9869a63adb9fbd69858212666932` |
...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260920T194031027Z` |
...
| 准入原因没有下发给车：全部 VehicleBusinessStateSnapshot 的 blockingFacts 里都没有缺绑定的原因码、需求号或任务类型；且至少有一份快照是在原因被记下之后发的（规格第 5.3 节） | PASS | `快照 ≥1 份 / 含准入原因 0 份 / 原因记下之后的快照 ≥1 份` | `快照 2 份 / 含准入原因 0 份 / 原因记下之后 2 份（原因观测于 2026-09-20T19:43:13.6414616+00:00，最后一份快照 2026-09-20T19:43:51.2940560+00:00，对照 JourneyBacklog.FirstSeenAt=2026-09-20 19:43:55.2421126+00:00）` |
