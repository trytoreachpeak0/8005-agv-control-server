...
失败原因：Timed out after 120s waiting for: the server re-sent the whole plan with three legs. Last observed: 2

## 身份

| 项 | 值 |
| --- | --- |
| runId | `20260920T092815680Z` |
| agvId | `AGV-L2-001` |
| batchId | `unspecified` |
...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260920T092815680Z` |
