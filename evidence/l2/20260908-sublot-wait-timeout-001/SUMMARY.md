...
| 项 | 值 |
| --- | --- |
| runId | `20260907T181244916Z` |
| agvId | `AGV-L2-001` |
| controlServerCommit | `2b62ebc8ca03a99ea7ac05b2b1ee7dcdaed07f03` |
| rig | `SyntheticOnboard` |
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260907T181244916Z` |
...
| 等待起点被单独记下来，不是复用 UpdatedAt | PASS | `有值` | `SublotWaitStartedAt=2026-09-07 18:12:52.9368154+00:00` |
| 窗口未到期时旅程原地不动 | PASS | `AwaitingSublot` | `AwaitingSublot` |
| 窗口未到期时需求仍是 Accepted | PASS | `Accepted` | `Accepted` |
| 旅程以 CANCELLED_BY_SUBLOT_WAIT_TIMEOUT 终结 | PASS | `Completed / CANCELLED_BY_SUBLOT_WAIT_TIMEOUT` | `Completed / CANCELLED_BY_SUBLOT_WAIT_TIMEOUT` |
| 需求终态为 Cancelled | PASS | `Cancelled` | `Cancelled` |
| 车辆调度租约已释放 | PASS | `已释放` | `ReleasedAt=2026-09-07 18:13:03.9135313+00:00` |
| 那条没人回答的条码录入请求被结算了 | PASS | `已结算` | `AcknowledgedAt=2026-09-07 18:13:03.9135313+00:00` |
