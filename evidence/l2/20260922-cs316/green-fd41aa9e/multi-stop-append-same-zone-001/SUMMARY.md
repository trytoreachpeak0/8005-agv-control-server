...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260922T105731341Z` |
...
| 当前下一站没被动：序位 1 还是追加之前那一个停靠，站号也没被改写（REQ-0196） | PASS | `journey:2e536fda-7569-4759-90ef-d2376389df09\|PICKUP@12` | `journey:2e536fda-7569-4759-90ef-d2376389df09\|PICKUP@12` |
| 三个停靠的序位是 1,2,3，连续且无重复 | PASS | `1,2,3` | `1,2,3` |
| 车上收到的最后一版计划带三条腿：计划是整体替换下发的（ADR-cross-0053） | PASS | `3` | `3` |
| 第二条需求被受理过：积压行上有受理时刻，没有被任何 EN_ROUTE_APPEND_* 挡住 | PASS | `(有受理时刻，理由不是 EN_ROUTE_APPEND_*)` | `ACCEPTED accepted=yes` |
