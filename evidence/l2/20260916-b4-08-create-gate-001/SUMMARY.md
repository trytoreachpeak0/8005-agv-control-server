...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260916T135125214Z` |
...
| 判据 | 结论 | 期望 | 实际 |
| --- | --- | --- | --- |
| 目录处于 Fresh 且有一次完整确认 | PASS | `Fresh + 已确认` | `Fresh + 2026-09-16 13:51:44.1503259+00:00` |
