...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260916T135102981Z` |
...
| 设计态读回了三个站点 | PASS | `3` | `3` |
| 运行态周期也跑过（移除集已读回，空是正常答案） | PASS | `(非空)` | `2026-09-16 13:51:22.0636088+00:00` |
