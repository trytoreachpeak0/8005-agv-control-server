...
| stageRoot | `C:\actions-runner\win11-01-control-server-desktop\_work\_temp\real-rig-35449602428-1\_stage\l2-20260919T144922813Z` |
...
| 车载端退出时没有留下结果：OperationResults 0 行，装货操作仍是 Prepared | PASS | `0 行 / Prepared` | `0 行 / Prepared` |
| 重启后车载端握手如实上报那一次没了结的 attempt | PASS | `c5baab59-ebbf-0855-888b-986ee4a52335` | `c5baab59-ebbf-0855-888b-986ee4a52335` |
