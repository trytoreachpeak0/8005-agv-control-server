...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260910T015149366Z` |
...
| 第一步握手：恢复会话已开，作用域是这一单这一次 attempt，管理员角色已认证 | PASS | `b156a6be-aef0-419f-9626-6e1a7d1080db / MAINTENANCE_ADMINISTRATOR / 含仓位 1` | `b156a6be-aef0-419f-9626-6e1a7d1080db / MAINTENANCE_ADMINISTRATOR / [1]` |
| 第二、三步握手：车载端报的动作是 COMPENSATE_LOAD_ALL_EMPTY，服务端授权并选定它 | PASS | `COMPENSATE_LOAD_ALL_EMPTY / b156a6be-aef0-419f-9626-6e1a7d1080db / 2ecf62d3-8913-d55f-b28d-b62bbb20f0d3` | `COMPENSATE_LOAD_ALL_EMPTY / b156a6be-aef0-419f-9626-6e1a7d1080db / 2ecf62d3-8913-d55f-b28d-b62bbb20f0d3` |
...
| 那条永远等不到 LoadResult 的 LoadBatch 命令，被补偿这一路同样结算掉了 | PASS | `补偿前挂着 / 补偿后已结算` | `补偿前挂着 / 2026-09-10 01:52:20.2124489+00:00` |
