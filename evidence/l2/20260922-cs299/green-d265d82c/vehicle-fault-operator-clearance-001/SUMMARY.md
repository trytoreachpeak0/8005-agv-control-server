...
| 项 | 值 |
| --- | --- |
| runId | `20260922T170956715Z` |
| agvId | `AGV-L2-001` |
| batchId | `unspecified` |
| controlServerCommit | `d265d82c5e6caf7b3f802cd4c4d618883ce3d7d4` |
...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260922T170956715Z` |
...
| 车重新接单：同一条需求在一趟新旅程上再派给这台车（需求改派、车恢复可派） | PASS | `1 趟新旅程 / 需求 6aab5e6d-59fd-4846-8e42-7310bf63ef10` | `1 趟 / 6aab5e6d-59fd-4846-8e42-7310bf63ef10` |
