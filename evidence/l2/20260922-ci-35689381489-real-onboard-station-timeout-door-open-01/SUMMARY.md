...
| stageRoot | `C:\actions-runner\win11-01-control-server-desktop\_work\_temp\real-rig-35689381489-1\_stage\l2-20260922T052719384Z` |
...
| 期限未到：门开着也不挂告警，旅程原地等装货结果 | PASS | `读于期限前 / AwaitingLoadResult / 无阻断码` | `读于期限前 35.3 s / AwaitingLoadResult / ''` |
| 期限到期挂上 STATION_TIMEOUT_DOOR_NOT_CLOSED：开始时间不早于期限，stage 仍是 AwaitingLoadResult（不是 Blocked），装货仍在途，需求未被终结 | PASS | `AwaitingLoadResult / since >= 2026-09-22T05:28:25.0690640+00:00 / Prepared / Accepted` | `AwaitingLoadResult / since 2026-09-22 05:28:25.949207+00:00 / Prepared / Accepted` |
...
| 过期 30 秒后仍然如此：同一个告警码、开始时间不动，stage 仍是 AwaitingLoadResult，装货仍在途、车载端一份结果都没报，需求未终结，没有恢复，会话 Ready，门仍开着 | PASS | `AwaitingLoadResult / STATION_TIMEOUT_DOOR_NOT_CLOSED since 2026-09-22 05:28:25.949207+00:00 / Prepared / 0 result / Accepted / 恢复会话 0 / 恢复工作流 0 / RecoveryRequired 操作 0 / Ready / OPEN` | `AwaitingLoadResult / STATION_TIMEOUT_DOOR_NOT_CLOSED since 2026-09-22 05:28:25.949207+00:00 / Prepared / 0 result / Accepted / 恢复会话 0 / 恢复工作流 0 / RecoveryRequired 操作 0 / Ready / OPEN/EMPTY/0/0` |
