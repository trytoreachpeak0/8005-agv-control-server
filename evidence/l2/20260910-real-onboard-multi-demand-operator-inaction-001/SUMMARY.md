...
失败原因：Response status code does not indicate success: 409 (Conflict).

## 身份

| 项 | 值 |
| --- | --- |
| runId | `20260910T082229064Z` |
| agvId | `AGV-L2-001` |
| batchId | `BATCH-3` |
...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260910T082229064Z` |
