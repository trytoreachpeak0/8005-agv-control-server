...
| 项 | 值 |
| --- | --- |
| runId | `20260904T034532642Z` |
| agvId | `AGV-L2-001` |
| controlServerCommit | `64e9bcca8e8212d6c39cb9b21b18ab41194d7462` |
| rig | `SyntheticOnboard` |
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260904T034532642Z` |
...
| 装载转入恢复后，它造成的不安全不再被自身命令豁免 | FAIL | `DEPARTURE_SAFETY_NOT_READY` | `OPERATION_RECOVERY_REQUIRED` |
