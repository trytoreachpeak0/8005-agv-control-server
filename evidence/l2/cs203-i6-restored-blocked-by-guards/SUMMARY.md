...
失败原因：Timed out after 120s waiting for: the STAGING_TO_WIRE load committed and the journey reached its second leg. Last observed: "AwaitingSublot"

## 身份

| 项 | 值 |
| --- | --- |
| runId | `20260920T172226771Z` |
| agvId | `AGV-L2-001` |
| batchId | `unspecified` |
...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260920T172226771Z` |
