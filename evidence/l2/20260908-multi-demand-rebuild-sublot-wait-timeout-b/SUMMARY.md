...
| 项 | 值 |
| --- | --- |
| runId | `20260908T044926274Z` |
| agvId | `AGV-L2-001` |
| controlServerCommit | `bc145629ff8beafe5e09f65fef0c089815d2061a` |
| rig | `SyntheticOnboard` |
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260908T044926274Z` |
...
| 等待起点被单独记下来，不是复用 UpdatedAt | PASS | `有值` | `SublotWaitStartedAt=2026-09-08 04:49:34.218768+00:00` |
...
| 车辆调度租约已释放 | PASS | `已释放` | `ReleasedAt=2026-09-08 04:49:45.2098857+00:00` |
| 那条没人回答的条码录入请求被结算了 | PASS | `已结算` | `AcknowledgedAt=2026-09-08 04:49:45.2098857+00:00` |
| 按业务键写下了永久取消抑制 | PASS | `1 条 / CANCELLED_BY_STATION_TIMEOUT` | `1 条 / CANCELLED_BY_STATION_TIMEOUT / key=L2-SUBLOT-20260908T044926274Z-A\|WIRE_TO_GATE` |
