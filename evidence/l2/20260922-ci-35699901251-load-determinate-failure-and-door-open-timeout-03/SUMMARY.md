...
| stageRoot | `C:\actions-runner\win11-01-control-server\_work\_temp\l2-35699901251-1\_stage\l2-20260922T073737527Z-slot2` |
...
| 确定失败是在本站期限之后收到的（这一格的前提） | PASS | `>= 2026-09-22T07:38:14.3647695+00:00` | `2026-09-22T07:38:15.4758319+00:00` |
...
| 租约与车辆占用释放，悬空的装货命令被结算（不会再重放进后面的会话） | PASS | `租约已释放 / 占用已释放 / 装货命令已结算` | `ReleasedAt=2026-09-22 07:38:15.9193553+00:00 / VehicleOccupancyReleasedAt=2026-09-22 07:38:15.9193553+00:00 / AcknowledgedAt=2026-09-22 07:38:15.9193553+00:00` |
...
| 告警挂上：stage 仍是 AwaitingLoadResult（不是 Blocked）、开始时间不早于期限、需求与租约都没动 | PASS | `AwaitingLoadResult / since >= 2026-09-22T07:38:37.9807519+00:00 / Prepared / Accepted / 租约未释放` | `AwaitingLoadResult / since 2026-09-22 07:38:38.9213728+00:00 / Prepared / Accepted / ReleasedAt=''` |
| 告警挂着期间运行时又跑了几轮：仍在 AwaitingLoadResult、同一个码、开始时间不变 | PASS | `AwaitingLoadResult / STATION_TIMEOUT_DOOR_NOT_CLOSED since 2026-09-22 07:38:38.9213728+00:00` | `AwaitingLoadResult / STATION_TIMEOUT_DOOR_NOT_CLOSED since 2026-09-22 07:38:38.9213728+00:00` |
