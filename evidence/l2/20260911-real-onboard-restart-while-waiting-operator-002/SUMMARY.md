...
| 项 | 值 |
| --- | --- |
| runId | `20260911T030132471Z` |
| agvId | `AGV-L2-001` |
| batchId | `BATCH-3` |
| controlServerCommit | `5cc347f1ee6cba2c235e9ec763f4ece48af391b3` |
...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260911T030132471Z` |
...
| 重启后车载端握手如实上报那一次未结的 attempt | PASS | `c5d98a92-57b6-9f53-ad00-af4316259908` | `c5d98a92-57b6-9f53-ad00-af4316259908` |
...
| 车载端报文逐条符合 protocol-v0.3.0 的 JSON Schema（真车载端包写进 `ProtocolInbox.RequestJson` 的每一行） | PASS | `退出码 0，校验行数 > 0，未登记违约 0` | `退出码 0：Schema conformance (protocol-v0.3.0): 22 lines, 22 distinct, 10 message types, 0 distinct violations, 0 known; schema compilation 17643 ms.` |
