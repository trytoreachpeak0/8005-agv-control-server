...
| stageRoot | `C:\actions-runner\win11-01-control-server\_work\_temp\l2-35361077376-1\_stage\l2-20260918T152804934Z-slot2` |
...
| 车收到的就是服务端落库的那条命令 | PASS | `33028ee3-95a1-4743-8aa1-c2017cb3c5d5` | `33028ee3-95a1-4743-8aa1-c2017cb3c5d5` |
...
| 重连后补发的是同一条命令（同一个 messageId），不是新的一次下发 | PASS | `>=2 receipts of 33028ee3-95a1-4743-8aa1-c2017cb3c5d5` | `33028ee3-95a1-4743-8aa1-c2017cb3c5d5,33028ee3-95a1-4743-8aa1-c2017cb3c5d5` |
| 车只报了一次结果 | PASS | `1` | `1` |
| 一次下发只有一行激活，补报没有产生第二次激活 | PASS | `1` | `1` |
| 生效配置写了一行，就是这次激活、就是它的目标指纹 | PASS | `1 / c180cbf1-c3b4-472b-805a-4521b7fde82b / de93ca3d9eda7b619dd3ea2e8824f8592a3471b11ff723eba3dbc12ea6f69da9` | `1 / c180cbf1-c3b4-472b-805a-4521b7fde82b / de93ca3d9eda7b619dd3ea2e8824f8592a3471b11ff723eba3dbc12ea6f69da9` |
