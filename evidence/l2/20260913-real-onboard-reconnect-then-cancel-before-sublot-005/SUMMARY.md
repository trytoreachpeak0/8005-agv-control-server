...
失败原因：The variable '$sessionAfter' cannot be retrieved because it has not been set.

## 身份

| 项 | 值 |
| --- | --- |
| runId | `20260913T072606829Z` |
| agvId | `AGV-L2-001` |
| batchId | `BATCH-3` |
| controlServerCommit | `606400551ece9c2d6d5b572a89094d4b06a52bfe` |
...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260913T072606829Z` |
...
| 车载端报文逐条符合 protocol-v0.3.0 的 JSON Schema（真车载端包写进 `ProtocolInbox.RequestJson` 的每一行） | PASS | `退出码 0，校验行数 > 0，未登记违约 0` | `退出码 0：Schema conformance (protocol-v0.3.0): 10 lines, 10 distinct, 5 message types, 0 distinct violations, 0 known; schema compilation 11482 ms.` |
