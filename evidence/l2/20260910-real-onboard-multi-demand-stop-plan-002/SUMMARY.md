...
失败原因：Timed out after 120s waiting for: a journey was created and dispatched to the first pickup. Last observed: (nothing)

## 身份

| 项 | 值 |
| --- | --- |
| runId | `20260910T053317994Z` |
| agvId | `AGV-L2-001` |
| batchId | `BATCH-3` |
| controlServerCommit | `28aab696f4f25e76270b338a9cff4a55be13e132` |
...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260910T053317994Z` |
