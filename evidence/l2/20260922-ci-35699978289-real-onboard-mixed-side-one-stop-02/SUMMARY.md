...
| stageRoot | `C:\actions-runner\win11-01-control-server-desktop\_work\_temp\real-rig-35699978289-1\_stage\l2-20260922T073825944Z` |
...
| 服务端：12 号站被车载端确认的清单里有一版同时列着乙丙两条清单项（正事实，从发件箱读） | PASS | `L2-MSO-B-20260922T073825944Z,L2-MSO-C-20260922T073825944Z` | `worklist r2 @N1-3_N2-5 L2-MSO-C-20260922T073825944Z/PICKUP,L2-MSO-B-20260922T073825944Z/PICKUP` |
| 车载端：清单确认之后，UIA 的本站清单列表（WorklistItems）同时有乙丙两行 | PASS | `两行 L2-MSO-B-20260922T073825944Z,L2-MSO-C-20260922T073825944Z` | `L2-MSO-C-20260922T073825944Z/UNASSIGNED,L2-MSO-B-20260922T073825944Z/UNASSIGNED` |
| 装货先前后后、第二条命令在第一条闭环之后才开锁：丙（后侧）的装货命令建在乙（前侧）的装货提交之后；模拟器采样里丙那一仓第一次未锁闭晚于乙那一仓最后一次未锁闭（REQ-0357）。这一条由驱动顺序保证（等乙提交、新清单确认后才扫丙），证不了车载端执行器串行，有判别力的是卸货的 10、11 | PASS | `丙命令 ≥ 乙提交 / 采样 乙仓最后 < 丙仓最先` | `乙提交 2026-09-22T15:40:29.2866603+08:00 丙命令 2026-09-22T07:40:32.4696867+00:00 / 采样 乙仓 2 [3..3] 丙仓 5 [5..5]` |
...
| 车载端：关卡清单确认之后，UIA 清单列表上乙那一行的侧标 FRONT、丙那一行 REAR（onboard-hmi#134 WorklistItemSide） | PASS | `L2-MSO-B-20260922T073825944Z/FRONT, L2-MSO-C-20260922T073825944Z/REAR` | `worklist r4 @关卡 L2-MSO-A-20260922T073825944Z/DROPOFF,L2-MSO-C-20260922T073825944Z/DROPOFF,L2-MSO-B-20260922T073825944Z/DROPOFF / 界面 L2-MSO-A-20260922T073825944Z/FRONT,L2-MSO-C-20260922T073825944Z/REAR,L2-MSO-B-20260922T073825944Z/FRONT` |
| 卸货一次一扇、先前后后（规格第 20 节，不是第 8.3 节「两组同开」）：前侧两条都卸在后侧那一条之前；丙的卸货命令建在乙的卸货提交之后；采样里丙那一仓在乙那一仓最后一次未锁闭之后才开 | PASS | `FRONT,FRONT,REAR / 丙命令 ≥ 乙提交 / 采样 乙仓最后 < 丙仓最先` | `FRONT,FRONT,REAR / 乙提交 2026-09-22T15:42:23.6918494+08:00 丙命令 2026-09-22T07:42:25.4907477+00:00 / 采样 乙 [9..9] 丙 [11..11]` |
