...
| 项 | 值 |
| --- | --- |
| runId | `20260911T083238758Z` |
| agvId | `AGV-L2-001` |
| batchId | `BATCH-3` |
| controlServerCommit | `372c0558a1a5aaf00fd1a5fd1b3474d5d219f299` |
...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260911T083238758Z` |
...
| 关卡：三条装上车的需求逐条取空，每条卸货都提交，旅程 Completed（车载端拒收多项关卡清单时红，见 8005-agv-program#48） | FAIL | `Completed / 3 条卸货 Committed` | `AwaitingUnloadResult /  / 会话 RecoveryRequired / HANDSHAKE_INCOMPLETE / Timed out after 300s unloading journey 7294719e-e59f-b550-84cf-4676be68c450; stage AwaitingUnloadResult. / 车载端拒收作业清单：PROTOCOL_SCHEMA_INVALID@关卡清单(3 项) ×12` |
...
| 车载端报文逐条符合 protocol-v0.3.0 的 JSON Schema（真车载端包写进 `ProtocolInbox.RequestJson` 的每一行） | PASS | `退出码 0，校验行数 > 0，未登记违约 0` | `退出码 0：Schema conformance (protocol-v0.3.0): 268 lines, 268 distinct, 16 message types, 0 distinct violations, 0 known; schema compilation 23855 ms.` |
