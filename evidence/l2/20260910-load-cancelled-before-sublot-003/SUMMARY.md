...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260910T085942408Z` |
...
| 车辆调度租约已释放 | PASS | `已释放` | `ReleasedAt=2026-09-10 08:59:54.2043309+00:00` |
| 那条没人回答的条码录入请求被结算了 | PASS | `已结算` | `AcknowledgedAt=2026-09-10 08:59:54.2043309+00:00` |
| 按业务键写下了永久取消抑制 | PASS | `1 条 / CANCELLED_BY_OPERATOR` | `1 条 / CANCELLED_BY_OPERATOR / key=L2-SUBLOT-20260910T085942408Z-A\|WIRE_TO_GATE` |
