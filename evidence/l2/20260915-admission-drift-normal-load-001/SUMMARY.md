...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260915T030623982Z` |
...
| 车载端报文逐条符合 protocol-v0.3.0 的 JSON Schema（合成对端发出的每一行） | PASS | `退出码 0，校验行数 > 0，未登记违约 0` | `退出码 0：Schema conformance (protocol-v0.3.0): 17 lines, 17 distinct, 9 message types, 0 distinct violations, 0 known; schema compilation 15661 ms.` |
