...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260911T052310646Z` |
...
| 判据 | 结论 | 期望 | 实际 |
| --- | --- | --- | --- |
| 驱动脚本经自动化面扫码并钉死锁反馈之后，车报回真的 UNKNOWN：仓位操作 RecoveryRequired、旅程 Blocked | PASS | `7fd2687d-8592-4562-b66d-380ca45ec777 / RecoveryRequired / LOAD_RESULT_REQUIRES_RECOVERY` | `7fd2687d-8592-4562-b66d-380ca45ec777 / RecoveryRequired / LOAD_RESULT_REQUIRES_RECOVERY` |
...
| 车载端报文逐条符合 protocol-v0.3.0 的 JSON Schema（真车载端包写进 `ProtocolInbox.RequestJson` 的每一行） | PASS | `退出码 0，校验行数 > 0，未登记违约 0` | `退出码 0：Schema conformance (protocol-v0.3.0): 40 lines, 40 distinct, 14 message types, 0 distinct violations, 0 known; schema compilation 24790 ms.` |
