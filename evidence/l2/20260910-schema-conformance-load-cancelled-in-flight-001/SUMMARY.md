...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260910T105917316Z` |
...
| 取消工作流凭空仓证明结清，且钉的是在途那个 attempt | PASS | `Reconciled / e812192c-ae3b-535b-b4ad-1920f73f3aa0` | `Reconciled / e812192c-ae3b-535b-b4ad-1920f73f3aa0` |
...
| 那条永远等不到结果的装货命令被取消结算掉了 | PASS | `已结算` | `2026-09-10 10:59:27.5934448+00:00` |
...
| 车载端报文逐条符合 protocol-v0.3.0 的 JSON Schema（合成对端发出的每一行） | PASS | `退出码 0，校验行数 > 0，未登记违约 0` | `退出码 0：Schema conformance (protocol-v0.3.0): 17 lines, 17 distinct, 11 message types, 0 distinct violations, 0 known; schema compilation 17999 ms.` |
