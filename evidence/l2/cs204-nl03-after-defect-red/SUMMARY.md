...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260920T130958744Z` |
...
| 车在路上时不采信到站：单已报成功、位置已报到取货点，只有运动证据说车还没停稳，运行时转过两轮之后仍然不前进 | FAIL | `AwaitingPickupArrival` | `AwaitingLoadResult` |
