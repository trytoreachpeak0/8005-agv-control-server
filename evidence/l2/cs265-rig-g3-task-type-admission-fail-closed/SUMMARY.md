...
| 项 | 值 |
| --- | --- |
| runId | `20260920T234040487Z` |
| agvId | `AGV-L2-001` |
| batchId | `unspecified` |
| controlServerCommit | `f4a2f970469c0dd03ff585e242896a722049fc74` |
| onboardHmiCommit | `e6bea2674a54a80ea92f9df8031999d46c77d321` |
...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260920T234040487Z` |
...
| 准入原因没有下发给车：全部 VehicleBusinessStateSnapshot 的 blockingFacts 里都没有缺绑定的原因码、需求号或任务类型；且至少有一份快照是在原因被记下之后发的（规格第 5.3 节） | PASS | `快照 ≥1 份 / 含准入原因 0 份 / 原因记下之后的快照 ≥1 份` | `快照 2 份 / 含准入原因 0 份 / 原因记下之后 2 份（原因观测于 2026-09-20T23:43:01.1375725+00:00，最后一份快照 2026-09-20T23:43:38.3710031+00:00，对照 JourneyBacklog.FirstSeenAt=2026-09-20 23:43:42.3389563+00:00）` |
