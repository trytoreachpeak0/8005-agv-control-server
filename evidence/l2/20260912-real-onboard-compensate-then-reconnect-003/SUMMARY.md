...
| 项 | 值 |
| --- | --- |
| runId | `20260912T144553733Z` |
| agvId | `AGV-L2-001` |
| batchId | `BATCH-3` |
| controlServerCommit | `11bee907b6503bfe8158ac6826091ca81e1cb14b` |
| onboardHmiCommit | `86fe0a45debd561e1d671c704a51b2a05c2a1408` |
...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260912T144553733Z` |
...
| 补偿对账之后，恢复会话快照与补偿命令都已结清：快照被车确认或被新 revision 取代，命令被补偿结果结算 | PASS | `>= 2 recovery rows, 0 neither acknowledged nor fenced` | `5 recovery rows, 0 live` |
...
| 重连之后车还接得了单：下一条需求被受理并派车，驱动脚本经自动化面扫码后车开锁等操作员 | PASS | `cb5c24b8-874d-4235-96bb-7bf5d8e579b5 / 车在等操作员` | `cb5c24b8-874d-4235-96bb-7bf5d8e579b5 / 车在等操作员` |
...
| 车载端报文逐条符合 protocol-v0.3.0 的 JSON Schema（真车载端包写进 `ProtocolInbox.RequestJson` 的每一行） | PASS | `退出码 0，校验行数 > 0，未登记违约 0` | `退出码 0：Schema conformance (protocol-v0.3.0): 55 lines, 55 distinct, 14 message types, 0 distinct violations, 0 known; schema compilation 34029 ms.` |
