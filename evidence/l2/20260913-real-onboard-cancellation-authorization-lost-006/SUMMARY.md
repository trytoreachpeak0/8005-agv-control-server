...
| 项 | 值 |
| --- | --- |
| runId | `20260913T035801392Z` |
| agvId | `AGV-L2-001` |
| batchId | `BATCH-3` |
| controlServerCommit | `cdd1463d5b2e0dbca9d70db2f51a7089ba7399aa` |
| onboardHmiCommit | `1acb0181cbb7d4ad7a2351b064167f4e4875b1e7` |
...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260913T035801392Z` |
...
| 车载端报文逐条符合 protocol-v0.3.0 的 JSON Schema（真车载端包写进 `ProtocolInbox.RequestJson` 的每一行） | PASS | `退出码 0，校验行数 > 0，未登记违约 0` | `退出码 0：Schema conformance (protocol-v0.3.0): 24 lines, 24 distinct, 11 message types, 0 distinct violations, 0 known; schema compilation 17202 ms.` |
