...
| 项 | 值 |
| --- | --- |
| runId | `20260903T095319922Z` |
| agvId | `AGV-L2-001` |
| controlServerCommit | `fb9bbeb3fdd2a699f2223a805eef1d81d19d9a62` |
| onboardHmiCommit | `238b46eb2c9ae90584e4288a782176f66b7de942` |
| rig | `RealOnboard` |
| slotsSimulatorCommit | `fb5f7c593742bf98bc3957b8729a38aad5321f28` |
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260903T095319922Z` |
...
| UIA 录入的 sublot 经真车载端以 KEYBOARD 方式提交到服务端 | PASS | `L2-SUBLOT-20260903T095319922Z / KEYBOARD / L2-OPERATOR` | `L2-SUBLOT-20260903T095319922Z / KEYBOARD / L2-OPERATOR` |
...
| 装载操作提交（Committed），且记的是 UIA 录进去的那个 sublot | PASS | `Committed / L2-SUBLOT-20260903T095319922Z` | `Committed / L2-SUBLOT-20260903T095319922Z` |
