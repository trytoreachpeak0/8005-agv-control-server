...
| 项 | 值 |
| --- | --- |
| runId | `20260913T084022780Z` |
| agvId | `AGV-L2-001` |
| batchId | `batch-2` |
| controlServerCommit | `0619623c94ea606ba7e61db099a628e9bde18fad` |
...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260913T084022780Z` |
...
| 故障事实停在 SuspectedBlocked，证据码 VEHICLE_ORDER_FAILED，并记下了升级时刻 | PASS | `SuspectedBlocked / VEHICLE_ORDER_FAILED / 有升级时刻` | `SuspectedBlocked / VEHICLE_ORDER_FAILED / 2026-09-13 08:41:03.4165336+00:00` |
