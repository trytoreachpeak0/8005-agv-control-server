...
| stageRoot | `C:\Windows\ServiceProfiles\NetworkService\AppData\Local\Temp\l2-20260912T151715306Z` |
...
| 车收到的就是服务端落库的那条命令 | PASS | `37278088-ccf8-4744-9931-000f74adc34a` | `37278088-ccf8-4744-9931-000f74adc34a` |
...
| 重连后补发的是同一条命令（同一个 messageId），不是新的一次下发 | PASS | `>=2 receipts of 37278088-ccf8-4744-9931-000f74adc34a` | `37278088-ccf8-4744-9931-000f74adc34a,37278088-ccf8-4744-9931-000f74adc34a` |
| 车只报了一次结果 | PASS | `1` | `1` |
| 一次下发只有一行激活，补报没有产生第二次激活 | PASS | `1` | `1` |
| 生效配置写了一行，就是这次激活、就是它的目标指纹 | PASS | `1 / a2547a62-a93d-473c-99a1-05747fe5385a / de93ca3d9eda7b619dd3ea2e8824f8592a3471b11ff723eba3dbc12ea6f69da9` | `1 / a2547a62-a93d-473c-99a1-05747fe5385a / de93ca3d9eda7b619dd3ea2e8824f8592a3471b11ff723eba3dbc12ea6f69da9` |
