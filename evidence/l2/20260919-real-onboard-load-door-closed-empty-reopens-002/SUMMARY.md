...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260918T175628473Z` |
...
| 出厂配置下按取消：车载端发出针对这笔装货的取消请求，服务端授权（AUTHORIZED），范围就是这个仓 | PASS | `2ae84e97-910a-db5a-b901-b687fb22dc1a / LoadCancellationAuthorization AUTHORIZED [1]` | `2ae84e97-910a-db5a-b901-b687fb22dc1a / LoadCancellationAuthorization AUTHORIZED [1]` |
...
| 车辆释放：调度租约与车辆占用都释放，没有去关卡的单 | PASS | `租约已释放 / 占用已释放 / TO_GATE 0` | `ReleasedAt='2026-09-18 17:57:57.6568633+00:00' / VehicleOccupancyReleasedAt='2026-09-18 17:57:57.6568633+00:00' / TO_GATE 0` |
