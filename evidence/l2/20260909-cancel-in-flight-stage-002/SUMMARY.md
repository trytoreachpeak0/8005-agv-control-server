...
| 项 | 值 |
| --- | --- |
| runId | `20260909T141752812Z` |
| agvId | `AGV-L2-001` |
| controlServerCommit | `67043ad0c717dbfbcc53ceb3dea8fdf2152f190b` |
| rig | `SyntheticOnboard` |
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260909T141752812Z` |
...
| 车辆调度租约已释放 | PASS | `已释放` | `ReleasedAt=2026-09-09 14:18:06.1486662+00:00` |
| 那条没人回答的条码录入请求被结算了 | PASS | `已结算` | `AcknowledgedAt=2026-09-09 14:18:06.1486662+00:00` |
| 按业务键写下了永久取消抑制 | PASS | `1 条 / CANCELLED_BY_OPERATOR` | `1 条 / CANCELLED_BY_OPERATOR / key=L2-SUBLOT-20260909T141752812Z-A\|WIRE_TO_GATE` |
