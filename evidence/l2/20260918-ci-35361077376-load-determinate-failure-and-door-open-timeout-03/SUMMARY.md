...
| stageRoot | `C:\actions-runner\win11-01-control-server\_work\_temp\l2-35361077376-1\_stage\l2-20260918T151620585Z-slot3` |
...
| 确定失败是在本站期限之后收到的（这一格的前提） | PASS | `>= 2026-09-18T15:16:56.7137137+00:00` | `2026-09-18T15:16:57.8669998+00:00` |
...
| 租约与车辆占用释放，悬空的装货命令被结算（不会再重放进后面的会话） | PASS | `租约已释放 / 占用已释放 / 装货命令已结算` | `ReleasedAt=2026-09-18 15:16:58.6571236+00:00 / VehicleOccupancyReleasedAt=2026-09-18 15:16:58.6571236+00:00 / AcknowledgedAt=2026-09-18 15:16:58.6571236+00:00` |
...
| 告警挂上：stage 仍是 AwaitingLoadResult（不是 Blocked）、开始时间不早于期限、需求与租约都没动 | PASS | `AwaitingLoadResult / since >= 2026-09-18T15:17:20.7147373+00:00 / Prepared / Accepted / 租约未释放` | `AwaitingLoadResult / since 2026-09-18 15:17:21.6537006+00:00 / Prepared / Accepted / ReleasedAt=''` |
| 告警挂着期间运行时又跑了几轮：仍在 AwaitingLoadResult、同一个码、开始时间不变 | PASS | `AwaitingLoadResult / STATION_TIMEOUT_DOOR_NOT_CLOSED since 2026-09-18 15:17:21.6537006+00:00` | `AwaitingLoadResult / STATION_TIMEOUT_DOOR_NOT_CLOSED since 2026-09-18 15:17:21.6537006+00:00` |
