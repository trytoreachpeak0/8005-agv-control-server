...
| 项 | 值 |
| --- | --- |
| runId | `20260907T165128923Z` |
| agvId | `AGV-L2-001` |
| controlServerCommit | `646624acc98eb3d7cacb330eadb1f3f3c8ecc76f` |
| rig | `SyntheticOnboard` |
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260907T165128923Z` |
...
| 判据 | 结论 | 期望 | 实际 |
| --- | --- | --- | --- |
| 目录处于 Fresh 且有一次完整确认 | PASS | `Fresh + 已确认` | `Fresh + 2026-09-07 16:51:40.2783048+00:00` |
