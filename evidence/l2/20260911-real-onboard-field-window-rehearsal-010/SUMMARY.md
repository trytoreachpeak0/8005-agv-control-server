...
| 项 | 值 |
| --- | --- |
| runId | `20260911T143938427Z` |
| agvId | `AGV-L2-001` |
| batchId | `BATCH-3` |
| controlServerCommit | `a44712a13e4995e3aeb70ffb136a6cfe4115e886` |
...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260911T143938427Z` |
...
| 采集器：三个场景都有现场记录，且记录由驱动脚本按实际动作写出（模拟器 IO 下无人到场，照片不适用） | PASS | `"3 个场景 / drivenBy 非空"` | `"3 个场景 / drivenBy=FieldOperator.psm1 run 20260911T143938427Z"` |
...
| 车载端报文逐条符合 protocol-v0.3.0 的 JSON Schema（真车载端包写进 `ProtocolInbox.RequestJson` 的每一行） | PASS | `退出码 0，校验行数 > 0，未登记违约 0` | `退出码 0：Schema conformance (protocol-v0.3.0): 182 lines, 182 distinct, 11 message types, 0 distinct violations, 0 known; schema compilation 21439 ms.` |
