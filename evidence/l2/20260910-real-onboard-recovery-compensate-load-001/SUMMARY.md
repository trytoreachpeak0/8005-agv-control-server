...
失败原因：Exception calling "Confirm" with "1" argument(s): "No dialog titled '补偿清空' from pid 17304 within 30s. Windows seen: 8005 多仓位AGV车载端."

## 身份

| 项 | 值 |
| --- | --- |
| runId | `20260910T012118529Z` |
| agvId | `AGV-L2-001` |
| batchId | `BATCH-3` |
...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260910T012118529Z` |
