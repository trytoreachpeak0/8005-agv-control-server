...
| 项 | 值 |
| --- | --- |
| runId | `20260911T124032411Z` |
| 窗口 | `FW-SC1` 装卸站收敛语义 |
| 现场 | L2 真装置彩排（本机） |
| 现场人员 | 无人到场，FieldOperator.psm1 run 20260911T123522650Z |
| agvId | `AGV-L2-001` |
...
| SC1-B-06 | 确定失败之后旅程自己离开这一格，不需要任何人按任何按钮 | PASS | `不是 2/AwaitingLoadResult` | `4/AwaitingLoadResult` |
...
| SC1-C-05 | 关门之后按真实 IO 读数结算（决策 1 会先重开一轮），告警随之消失 | PASS | `告警清空 / 操作已结算` | `AwaitingLoadResult / - / Failed` |
| SC1-W-01 | 三个场景都有现场记录，且记录由驱动脚本按实际动作写出（模拟器 IO 下无人到场，照片不适用） | PASS | `3 个场景 / drivenBy 非空` | `3 个场景 / drivenBy=FieldOperator.psm1 run 20260911T123522650Z` |
...
| `drivenBy` | `FieldOperator.psm1 run 20260911T123522650Z` |
| `A.slotOperationAttemptId` | `5bf14dde-11f5-fb5a-98f5-bc6d019aa1d5` |
| `A.phaseCounts` | `UNLOCKING=3 WAITING_OPERATOR=3` |
| `B.slotOperationAttemptId` | `60663bc8-85aa-fe5b-a032-ee1dd9369a0d` |
...
| `B.journeyPosition` | `4/AwaitingLoadResult` |
| `C.finalStage` | `AwaitingLoadResult / -` |
