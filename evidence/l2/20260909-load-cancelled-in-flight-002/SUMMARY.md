...
| 项 | 值 |
| --- | --- |
| runId | `20260909T145250708Z` |
| agvId | `AGV-L2-001` |
| controlServerCommit | `42a85f0853ac2e190ff705dc14be4c8ee90e72fe` |
| rig | `SyntheticOnboard` |
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260909T145250708Z` |
...
| 取消工作流凭空仓证明结清，且钉的是在途那个 attempt | PASS | `Reconciled / 63b07acf-09c1-b559-b12c-c9e10ff846dc` | `Reconciled / 63b07acf-09c1-b559-b12c-c9e10ff846dc` |
...
| 那条永远等不到结果的装货命令被取消结算掉了 | PASS | `已结算` | `2026-09-09 14:53:09.803286+00:00` |
