...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260910T110232854Z` |
...
| 持货钟在第一批装载闭环后开始走 | PASS | `a timestamp` | `2026-09-10 11:02:44.4361214+00:00` |
...
| 车载端报文逐条符合 protocol-v0.3.0 的 JSON Schema（合成对端发出的每一行） | PASS | `退出码 0，校验行数 > 0，未登记违约 0` | `退出码 0：Schema conformance (protocol-v0.3.0): 22 lines, 22 distinct, 9 message types, 0 distinct violations, 0 known; schema compilation 19340 ms.` |
