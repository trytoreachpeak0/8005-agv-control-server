...
| stageRoot | `C:\actions-runner\win11-01-control-server\_work\_temp\l2-35699901251-1\_stage\l2-20260922T080826239Z-slot1` |
...
| 车收到的就是服务端落库的那条命令 | PASS | `47180e18-ba8a-4e4a-890a-6e91714a20ee` | `47180e18-ba8a-4e4a-890a-6e91714a20ee` |
...
| 重连后补发的是同一条命令（同一个 messageId），不是新的一次下发 | PASS | `>=2 receipts of 47180e18-ba8a-4e4a-890a-6e91714a20ee` | `47180e18-ba8a-4e4a-890a-6e91714a20ee,47180e18-ba8a-4e4a-890a-6e91714a20ee` |
| 车只报了一次结果（等到它记下发过一次、再多转三轮之后仍然是一次） | PASS | `1` | `1` |
| 一次下发只有一行激活，补报没有产生第二次激活 | PASS | `1` | `1` |
| 生效配置写了一行，就是这次激活、就是它的目标指纹 | PASS | `1 / 8c7a89af-b9f5-461b-8563-a029da897504 / de93ca3d9eda7b619dd3ea2e8824f8592a3471b11ff723eba3dbc12ea6f69da9` | `1 / 8c7a89af-b9f5-461b-8563-a029da897504 / de93ca3d9eda7b619dd3ea2e8824f8592a3471b11ff723eba3dbc12ea6f69da9` |
