...
| 项 | 值 |
| --- | --- |
| runId | `20260908T074430339Z` |
| agvId | `AGV-L2-001` |
| controlServerCommit | `7b6231bd8b2157ebad47e1348178a0143a771aac` |
| rig | `SyntheticOnboard` |
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260908T074430339Z` |
...
| 判据 | 结论 | 期望 | 实际 |
| --- | --- | --- | --- |
| 目录处于 Fresh 且有一次完整确认 | PASS | `Fresh + 已确认` | `Fresh + 2026-09-08 07:44:37.6371147+00:00` |
