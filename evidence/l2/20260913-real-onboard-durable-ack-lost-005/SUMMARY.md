...
| 项 | 值 |
| --- | --- |
| runId | `20260913T064044912Z` |
| agvId | `AGV-L2-001` |
| batchId | `BATCH-3` |
| controlServerCommit | `8ef2e18006c67a052904a55a9cb648c48ff7ebe1` |
| onboardHmiCommit | `a56a59d961f46e20a0208977a4ba53b11d9c79ac` |
...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260913T064044912Z` |
...
| 补发的 OperationResult 被服务端以 DurableAck 确认（不是掐连接） | PASS | `DurableAck for 2143d83f-eb6c-fc52-a5f0-1fe6ae767275 on a connection after 1` | `acknowledged` |
...
| 车载端报文逐条符合 protocol-v0.3.0 的 JSON Schema（真车载端包写进 `ProtocolInbox.RequestJson` 的每一行） | PASS | `退出码 0，校验行数 > 0，未登记违约 0` | `退出码 0：Schema conformance (protocol-v0.3.0): 44 lines, 44 distinct, 11 message types, 0 distinct violations, 0 known; schema compilation 16594 ms.` |
