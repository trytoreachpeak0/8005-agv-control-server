...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260911T111959233Z` |
...
| 判据 | 结论 | 期望 | 实际 |
| --- | --- | --- | --- |
| 驱动脚本经自动化面扫码并钉死锁反馈之后，车报回真的 UNKNOWN：仓位操作 RecoveryRequired、旅程 Blocked | PASS | `811e5f35-2fb7-42ad-a5cb-df84db27f6ea / RecoveryRequired / LOAD_RESULT_REQUIRES_RECOVERY` | `811e5f35-2fb7-42ad-a5cb-df84db27f6ea / RecoveryRequired / LOAD_RESULT_REQUIRES_RECOVERY` |
...
| 车还回来了：下一条需求被受理并派车，驱动脚本经自动化面扫码后车开锁等操作员 | PASS | `17987b8e-0742-4bea-bc61-cf3d09fde813 / L2-FOC-20260911T111959233Z-NEXT / 车在等操作员` | `17987b8e-0742-4bea-bc61-cf3d09fde813 / L2-FOC-20260911T111959233Z-NEXT / 车在等操作员` |
| 车载端报文逐条符合 protocol-v0.3.0 的 JSON Schema（真车载端包写进 `ProtocolInbox.RequestJson` 的每一行） | PASS | `退出码 0，校验行数 > 0，未登记违约 0` | `退出码 0：Schema conformance (protocol-v0.3.0): 51 lines, 51 distinct, 14 message types, 0 distinct violations, 0 known; schema compilation 24850 ms.` |
