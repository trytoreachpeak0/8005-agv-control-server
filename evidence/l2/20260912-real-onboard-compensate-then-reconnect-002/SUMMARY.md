...
| 项 | 值 |
| --- | --- |
| runId | `20260912T141753719Z` |
| agvId | `AGV-L2-001` |
| batchId | `BATCH-3` |
| controlServerCommit | `219b033fcf0aad58652f7e4a9820b7ae9a781a73` |
| onboardHmiCommit | `a696adddeb28c98840971fc4ce48baa6ef0a010c` |
...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260912T141753719Z` |
...
| 重连之后车还接得了单：下一条需求被受理并派车，驱动脚本经自动化面扫码后车开锁等操作员 | PASS | `1a54c25e-a757-47a1-b483-b9ff1f5e5f2f / 车在等操作员` | `1a54c25e-a757-47a1-b483-b9ff1f5e5f2f / 车在等操作员` |
...
| 车载端报文逐条符合 protocol-v0.3.0 的 JSON Schema（真车载端包写进 `ProtocolInbox.RequestJson` 的每一行） | PASS | `退出码 0，校验行数 > 0，未登记违约 0` | `退出码 0：Schema conformance (protocol-v0.3.0): 60 lines, 60 distinct, 14 message types, 0 distinct violations, 0 known; schema compilation 19570 ms.` |
