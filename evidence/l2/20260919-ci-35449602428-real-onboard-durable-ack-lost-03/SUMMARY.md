...
| stageRoot | `C:\actions-runner\win11-01-control-server-desktop\_work\_temp\real-rig-35449602428-1\_stage\l2-20260919T145322694Z` |
...
| 确认丢失的那次装货已完成：会话重回 Ready 之后、卸货等操作员之前，HMI 上从未出现「上次装货操作未完成」（onboard-hmi#124） | PASS | `>= 10 HMI scans, 0 unfinished projections` | `77 scans, 0 seen` |
