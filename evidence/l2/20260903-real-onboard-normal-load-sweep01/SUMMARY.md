...
| 项 | 值 |
| --- | --- |
| runId | `20260903T121601607Z` |
| agvId | `AGV-L2-001` |
| controlServerCommit | `e5656372b2dd26f811fba6f6557da1243c7dbcd0` |
| onboardHmiCommit | `60a0efdbf14b8195a1c1fd5afa8e6f39945279aa` |
| rig | `RealOnboard` |
| slotsSimulatorCommit | `fb5f7c593742bf98bc3957b8729a38aad5321f28` |
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260903T121601607Z` |
...
| UIA 录入的 sublot 经真车载端以 KEYBOARD 方式提交到服务端 | PASS | `L2-SUBLOT-20260903T121601607Z / KEYBOARD / L2-OPERATOR` | `L2-SUBLOT-20260903T121601607Z / KEYBOARD / L2-OPERATOR` |
...
| 装载操作提交（Committed），且记的是 UIA 录进去的那个 sublot | PASS | `Committed / L2-SUBLOT-20260903T121601607Z` | `Committed / L2-SUBLOT-20260903T121601607Z` |
