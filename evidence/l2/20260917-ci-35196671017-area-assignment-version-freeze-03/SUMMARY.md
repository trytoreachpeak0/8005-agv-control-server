...
| stageRoot | `C:\Windows\ServiceProfiles\NetworkService\AppData\Local\Temp\l2-20260917T081816101Z` |
...
| 导入预览恰好列出在途的需求甲：原分组 FRONT（冻结版本 1）、新分组 REAR | PASS | `82a5faac-9867-40db-9328-4829e69dec60 N1-3 v1 FRONT->REAR` | `82a5faac-9867-40db-9328-4829e69dec60 N1-3 v1 FRONT->REAR` |
| 不停车生效之一：导入前后服务端是同一个进程（PID 与启动时刻都不变） | PASS | `pid 7004 ControlServer.Host started 2026-09-17T16:18:22.7628540+08:00` | `pid 7004 ControlServer.Host started 2026-09-17T16:18:22.7628540+08:00` |
...
| 回滚不改变已冻结的需求：需求乙仍冻结版本 2，回滚预览恰好列出在途的需求乙（REAR → FRONT） | PASS | `frozen 2 / b8b6cca0-c162-4e48-910b-04a65af13440 REAR->FRONT` | `frozen 2 / b8b6cca0-c162-4e48-910b-04a65af13440 REAR->FRONT` |
