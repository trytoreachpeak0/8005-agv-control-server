...
失败原因：Exception calling "ExecuteReader" with "0" argument(s): "SQLite Error 1: 'no such column: Status'."

## 身份

| 项 | 值 |
| --- | --- |
| runId | `20260920T175355628Z` |
| agvId | `AGV-L2-001` |
| batchId | `unspecified` |
...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260920T175355628Z` |
...
| 补偿依托恢复会话授权：工作流挂在这次打开的恢复会话上，命令就是工作流绑定的那一条，指向同一会话、同一尝试、同一仓位（AUTHORIZE_COMPENSATION_AGAINST_RECOVERY_SESSION） | PASS | `会话 da743cf2-8184-0150-adff-53f90a966884 / 命令 = 工作流绑定 / attempt 7fea57fa-f918-6151-b620-140e19415357 / 仓 1` | `会话 da743cf2-8184-0150-adff-53f90a966884 / 命令 6eed5045-c289-4f5f-926f-9624af2a20e0 vs 绑定 6eed5045-c289-4f5f-926f-9624af2a20e0 / attempt 7fea57fa-f918-6151-b620-140e19415357 / 仓 1` |
