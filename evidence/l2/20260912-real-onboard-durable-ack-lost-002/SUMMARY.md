...
| 项 | 值 |
| --- | --- |
| runId | `20260912T125619678Z` |
| agvId | `AGV-L2-001` |
| batchId | `BATCH-3` |
| controlServerCommit | `e90e924eeef387adb6839b5203b4b985146ff066` |
...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260912T125619678Z` |
...
| 补发的 OperationResult 被服务端以 DurableAck 确认（不是掐连接） | PASS | `DurableAck for c206f0fd-d2e5-8259-a291-8079010550d8 on a connection after 1` | `acknowledged` |
| 丢一次 ack 只换来一次重连：之后只有一条连接，而且它还开着 | FAIL | `2 connections, 1 open` | `2 connections, 0 open (#1: relay dropped DurableAck for OperationResult; #2: onboard closed)` |
...
| 车载端报文逐条符合 protocol-v0.3.0 的 JSON Schema（真车载端包写进 `ProtocolInbox.RequestJson` 的每一行） | PASS | `退出码 0，校验行数 > 0，未登记违约 0` | `退出码 0：Schema conformance (protocol-v0.3.0): 44 lines, 44 distinct, 11 message types, 0 distinct violations, 0 known; schema compilation 16965 ms.` |
