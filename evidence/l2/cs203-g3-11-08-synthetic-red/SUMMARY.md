...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260920T172658431Z` |
...
| 准入决策只冻结在卸货那次操作上，站点是机台站、任务类型 STAGING_TO_WIRE | FAIL | `one decision on UnloadSlotOperationAttemptId: N1-3_N1-7/STAGING_TO_WIRE` | `0 decision(s):` |
