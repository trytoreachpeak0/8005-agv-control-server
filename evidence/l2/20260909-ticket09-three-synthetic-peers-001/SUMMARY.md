...
| 项 | 值 |
| --- | --- |
| runId | `20260908T073948464Z` |
| agvId | `AGV-L2-001` |
| controlServerCommit | `93d1891e21c43bdd291020e2a9338061fb95ecd6` |
| rig | `SyntheticOnboard` |
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260908T073948464Z` |
...
| 服务端同时持有三台车的会话，一台一行 | FAIL | `AGV-FAKE-001,AGV-FAKE-002,AGV-FAKE-003` | `AGV-FAKE-001 AGV-FAKE-002 AGV-FAKE-003` |
| AGV-FAKE-001 的会话在服务端是 Ready | FAIL | `Ready` | `(缺行)` |
| AGV-FAKE-002 的会话在服务端是 Ready | FAIL | `Ready` | `(缺行)` |
| AGV-FAKE-003 的会话在服务端是 Ready | FAIL | `Ready` | `(缺行)` |
