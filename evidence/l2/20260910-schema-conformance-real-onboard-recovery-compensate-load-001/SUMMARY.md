...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260910T110515623Z` |
...
| 第一步握手：恢复会话已开，作用域是这一单这一次 attempt，管理员角色已认证 | PASS | `45150f78-453d-4764-89d7-aee07f9342ca / MAINTENANCE_ADMINISTRATOR / 含仓位 1` | `45150f78-453d-4764-89d7-aee07f9342ca / MAINTENANCE_ADMINISTRATOR / [1]` |
| 第二、三步握手：车载端报的动作是 COMPENSATE_LOAD_ALL_EMPTY，服务端授权并选定它 | PASS | `COMPENSATE_LOAD_ALL_EMPTY / 45150f78-453d-4764-89d7-aee07f9342ca / 2fe6a981-4db0-a859-babf-329b603e8552` | `COMPENSATE_LOAD_ALL_EMPTY / 45150f78-453d-4764-89d7-aee07f9342ca / 2fe6a981-4db0-a859-babf-329b603e8552` |
...
| 那条永远等不到 LoadResult 的 LoadBatch 命令，被补偿这一路同样结算掉了 | PASS | `补偿前挂着 / 补偿后已结算` | `补偿前挂着 / 2026-09-10 11:05:38.8922624+00:00` |
| 车载端报文逐条符合 protocol-v0.3.0 的 JSON Schema（真车载端包写进 `ProtocolInbox.RequestJson` 的每一行） | PASS | `退出码 0，校验行数 > 0，未登记违约 0` | `退出码 0：Schema conformance (protocol-v0.3.0): 37 lines, 37 distinct, 14 message types, 0 distinct violations, 0 known; schema compilation 22513 ms.` |
