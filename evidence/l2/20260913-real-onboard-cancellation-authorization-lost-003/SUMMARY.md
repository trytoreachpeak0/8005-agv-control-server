...
| 项 | 值 |
| --- | --- |
| runId | `20260913T032737079Z` |
| agvId | `AGV-L2-001` |
| batchId | `BATCH-3` |
| controlServerCommit | `c7f67d1dd00db52e6371f323a8ad1e7c2dd814d4` |
| onboardHmiCommit | `5e29f58fb521b53c3b33da893d0a618ee0e851a9` |
...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260913T032737079Z` |
...
| 车载端报文逐条符合 protocol-v0.3.0 的 JSON Schema（真车载端包写进 `ProtocolInbox.RequestJson` 的每一行） | PASS | `退出码 0，校验行数 > 0，未登记违约 0` | `退出码 0：Schema conformance (protocol-v0.3.0): 25 lines, 25 distinct, 12 message types, 0 distinct violations, 0 known; schema compilation 16914 ms.` |
