...
| 项 | 值 |
| --- | --- |
| runId | `20260919T162950037Z` |
| agvId | `AGV-L2-001` |
| batchId | `unspecified` |
| controlServerCommit | `2adcaed96bf8b47d2cdc0b56c9b41692ca7e3729` |
...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260919T162950037Z` |
...
| 此前已建的关卡单不被取消、不改单：同一个 UpperId 与 OrderId，仍是 CONFIRMED | PASS | `W2G-fe961b9a-c84b-4ba4-88f6-405cdf8c11de-GATE-1 / ORDER-000002 / CONFIRMED` | `W2G-fe961b9a-c84b-4ba4-88f6-405cdf8c11de-GATE-1 / ORDER-000002 / CONFIRMED` |
...
| 看板显示两条暂停及其来源：STAGING_TO_WIRE 目录变化／站点改名，WIRE_TO_GATE 目录变化／站点已不在目录 | PASS | `STAGING_TO_WIRE: 已暂停 目录变化 站点改名；WIRE_TO_GATE: 已暂停 目录变化 站点已不在目录` | `STAGING_TO_WIRE 在本图需求集合 230 派工待送取货 已暂停 目录变化，自 2026-09-19T16:31:03.5491632+00:00，站点改名 暂停 \| WIRE_TO_GATE 在本图需求集合 210 关卡 已暂停 目录变化，自 2026-09-19T16:32:01.983656+00:00，站点已不在目录 暂停` |
...
| 210 以原名称放回目录、确认过几轮之后，新的 WIRE_TO_GATE 需求仍不受理，原因码 TASK_TYPE_HELD，那条暂停仍未解除（站点恢复不自动解暂停） | PASS | `no journey / TASK_TYPE_HELD; hold 834aebc0253645b48c8ea001d228eb67 unreleased` | `no journey / TASK_TYPE_HELD; hold 834aebc0253645b48c8ea001d228eb67` |
