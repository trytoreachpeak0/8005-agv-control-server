...
失败原因：The term 'Wait-FieldCloseAnswer' is not recognized as a name of a cmdlet, function, script file, or executable program.
...
| 项 | 值 |
| --- | --- |
| runId | `20260919T022059777Z` |
| agvId | `AGV-L2-001` |
| batchId | `BATCH-3` |
| controlServerCommit | `dd80a08e1c453f3efd2a5abab40d0212cf8bb08b` |
...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260919T022059777Z` |
...
| 车载端报文逐条符合 protocol-v0.3.0 的 JSON Schema（真车载端包写进 `ProtocolInbox.RequestJson` 的每一行） | PASS | `退出码 0，校验行数 > 0，未登记违约 0` | `退出码 0：Schema conformance (protocol-v0.3.0): 60 lines, 60 distinct, 14 message types, 0 distinct violations, 0 known; schema compilation 94698 ms.` |
