...
失败原因：Timed out after 120s waiting for: slot 2 is open and waiting for cargo. Last observed: "CLOSED/EMPTY/1/0"

## 身份

| 项 | 值 |
| --- | --- |
| runId | `20260910T082007963Z` |
| agvId | `AGV-L2-001` |
| batchId | `BATCH-3` |
...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260910T082007963Z` |
