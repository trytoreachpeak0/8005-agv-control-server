...
失败原因：Timed out after 120s waiting for: the door alarm was withdrawn once the load settled. Last observed: (nothing)

## 身份

| 项 | 值 |
| --- | --- |
| runId | `20260909T130234852Z` |
| agvId | `AGV-L2-001` |
...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260909T130234852Z` |
...
| 站点期限的起点已经种下——它是决策 4 那一格的计时起点 | PASS | `有值` | `SublotWaitStartedAt=2026-09-09 13:02:52.8194491+00:00` |
