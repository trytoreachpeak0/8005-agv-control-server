...
| 项 | 值 |
| --- | --- |
| runId | `20260911T085140136Z` |
| agvId | `AGV-L2-001` |
| batchId | `BATCH-3` |
| controlServerCommit | `caffdee656cd3045e7717e5509f15b2d8ab848b0` |
...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260911T085140136Z` |
...
| 补偿对账那一刻服务端会话回到 Ready 并告诉了车：LoadCompensationResult 的首个应答里带 SessionReadiness READY（#46） | PASS | `READY` | `READY / 现在 RecoveryRequired / DEPARTURE_SAFETY_NOT_READY` |
...
| 车载端报文逐条符合 protocol-v0.3.0 的 JSON Schema（真车载端包写进 `ProtocolInbox.RequestJson` 的每一行） | PASS | `退出码 0，校验行数 > 0，未登记违约 0` | `退出码 0：Schema conformance (protocol-v0.3.0): 136 lines, 136 distinct, 15 message types, 0 distinct violations, 0 known; schema compilation 26977 ms.` |
