...
| 项 | 值 |
| --- | --- |
| runId | `20260908T053513131Z` |
| agvId | `AGV-L2-001` |
| controlServerCommit | `54d97d096b823d07172c64a2a9318cf08a912ca6` |
| rig | `SyntheticOnboard` |
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260908T053513131Z` |
...
| 等待起点被单独记下来，不是复用 UpdatedAt | PASS | `有值` | `SublotWaitStartedAt=2026-09-08 05:35:21.9633664+00:00` |
...
| 车辆调度租约已释放 | PASS | `已释放` | `ReleasedAt=2026-09-08 05:35:32.959205+00:00` |
| 那条没人回答的条码录入请求被结算了 | PASS | `已结算` | `AcknowledgedAt=2026-09-08 05:35:32.959205+00:00` |
| 按业务键写下了永久取消抑制 | PASS | `1 条 / CANCELLED_BY_STATION_TIMEOUT` | `1 条 / CANCELLED_BY_STATION_TIMEOUT / key=L2-SUBLOT-20260908T053513131Z-A\|WIRE_TO_GATE` |
