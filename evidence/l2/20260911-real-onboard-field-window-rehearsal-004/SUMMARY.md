...
失败原因：Timed out after 1800s unloading journey 067acc1b-4ae9-7e53-818c-394b5bd17caf; stage AwaitingUnloadResult.

## 身份

| 项 | 值 |
| --- | --- |
| runId | `20260911T060138087Z` |
| agvId | `AGV-L2-001` |
| batchId | `BATCH-3` |
...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260911T060138087Z` |
...
| 车载端报文逐条符合 protocol-v0.3.0 的 JSON Schema（真车载端包写进 `ProtocolInbox.RequestJson` 的每一行） | PASS | `退出码 0，校验行数 > 0，未登记违约 0` | `退出码 0：Schema conformance (protocol-v0.3.0): 1101 lines, 1101 distinct, 12 message types, 0 distinct violations, 0 known; schema compilation 19168 ms.` |
