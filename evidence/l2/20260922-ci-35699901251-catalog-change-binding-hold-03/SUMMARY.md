...
| stageRoot | `C:\actions-runner\win11-01-control-server\_work\_temp\l2-35699901251-1\_stage\l2-20260922T075622004Z-slot1` |
...
| 此前已建的关卡单不被取消、不改单：同一个 UpperId 与 OrderId，仍是 CONFIRMED | PASS | `W2G-0d5789c8-f7fe-4025-8637-b1737818d447-GATE-1 / ORDER-000002 / CONFIRMED` | `W2G-0d5789c8-f7fe-4025-8637-b1737818d447-GATE-1 / ORDER-000002 / CONFIRMED` |
...
| 看板显示两条暂停及其来源：STAGING_TO_WIRE 目录变化／站点改名，WIRE_TO_GATE 目录变化／站点已不在目录 | PASS | `STAGING_TO_WIRE: 已暂停 目录变化 站点改名；WIRE_TO_GATE: 已暂停 目录变化 站点已不在目录` | `STAGING_TO_WIRE 在本图需求集合 230 派工待送取货 已暂停 目录变化，自 2026-09-22T07:56:40.4669726+00:00，站点改名 暂停 \| WIRE_TO_GATE 在本图需求集合 210 关卡 已暂停 目录变化，自 2026-09-22T07:57:16.4811373+00:00，站点已不在目录 暂停` |
...
| 210 以原名称放回目录、确认过几轮之后，等着的与新来的 WIRE_TO_GATE 需求都仍不受理，原因码 TASK_TYPE_HELD，那条暂停仍未解除（站点恢复不自动解暂停） | PASS | `second: no journey / TASK_TYPE_HELD; third: no journey / TASK_TYPE_HELD; hold 47f7928b8aaa4039818c9e63042dad86 unreleased` | `second: no journey / TASK_TYPE_HELD; third: no journey / TASK_TYPE_HELD; hold 47f7928b8aaa4039818c9e63042dad86` |
