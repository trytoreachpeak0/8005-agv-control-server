...
| 项 | 值 |
| --- | --- |
| runId | `20260919T091546525Z` |
| agvId | `AGV-L2-001` |
| batchId | `batch-2` |
| controlServerCommit | `6fe8971f62e89dac4e2e66f9b9f2c4af79eb21a9` |
...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260919T091546525Z` |
...
| 重放用的是同一条命令身份（对端只有一条待答请求） | PASS | `operation:10654871-9faf-1954-87cd-f3642231a4ed` | `operation:10654871-9faf-1954-87cd-f3642231a4ed` |
