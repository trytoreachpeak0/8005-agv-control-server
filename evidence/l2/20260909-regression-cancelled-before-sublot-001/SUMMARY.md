...
| 项 | 值 |
| --- | --- |
| runId | `20260909T145332769Z` |
| agvId | `AGV-L2-001` |
| controlServerCommit | `42a85f0853ac2e190ff705dc14be4c8ee90e72fe` |
| rig | `SyntheticOnboard` |
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260909T145332769Z` |
...
| 车辆调度租约已释放 | PASS | `已释放` | `ReleasedAt=2026-09-09 14:53:45.1631094+00:00` |
| 那条没人回答的条码录入请求被结算了 | PASS | `已结算` | `AcknowledgedAt=2026-09-09 14:53:45.1631094+00:00` |
| 按业务键写下了永久取消抑制 | PASS | `1 条 / CANCELLED_BY_OPERATOR` | `1 条 / CANCELLED_BY_OPERATOR / key=L2-SUBLOT-20260909T145332769Z-A\|WIRE_TO_GATE` |
