...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260910T111313149Z` |
...
| 全程只有一个卸货 attempt，最终 Committed——重开不新建操作 | PASS | `Committed / dc5425b8-a622-095e-ac37-d6b5517a9304` | `Committed / dc5425b8-a622-095e-ac37-d6b5517a9304` |
| 需求终态为 Succeeded | PASS | `Succeeded` | `Succeeded` |
| 车载端报文逐条符合 protocol-v0.3.0 的 JSON Schema（真车载端包写进 `ProtocolInbox.RequestJson` 的每一行） | PASS | `退出码 0，校验行数 > 0，未登记违约 0` | `退出码 0：Schema conformance (protocol-v0.3.0): 49 lines, 49 distinct, 11 message types, 0 distinct violations, 0 known; schema compilation 18831 ms.` |
