...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260903T100649516Z` |
...
| UIA 录入的 sublot 经真车载端以 KEYBOARD 方式提交到服务端 | PASS | `L2-SUBLOT-20260903T100649516Z / KEYBOARD / L2-OPERATOR` | `L2-SUBLOT-20260903T100649516Z / KEYBOARD / L2-OPERATOR` |
...
| 装载操作提交（Committed），且记的是 UIA 录进去的那个 sublot | PASS | `Committed / L2-SUBLOT-20260903T100649516Z` | `Committed / L2-SUBLOT-20260903T100649516Z` |
