...
| 项 | 值 |
| --- | --- |
| runId | `20260919T180644647Z` |
| agvId | `AGV-L2-001` |
| batchId | `unspecified` |
| controlServerCommit | `fab28ccdad248e7df2ab5fcce63a065ae5c53009` |
...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260919T180644647Z` |
...
| 此前已建的关卡单不被取消、不改单：同一个 UpperId 与 OrderId，仍是 CONFIRMED | PASS | `W2G-46180791-c00a-4fab-ad17-5f15f6f4f49a-GATE-1 / ORDER-000002 / CONFIRMED` | `W2G-46180791-c00a-4fab-ad17-5f15f6f4f49a-GATE-1 / ORDER-000002 / CONFIRMED` |
...
| 看板显示两条暂停及其来源：STAGING_TO_WIRE 目录变化／站点改名，WIRE_TO_GATE 目录变化／站点已不在目录 | PASS | `STAGING_TO_WIRE: 已暂停 目录变化 站点改名；WIRE_TO_GATE: 已暂停 目录变化 站点已不在目录` | `STAGING_TO_WIRE 在本图需求集合 230 派工待送取货 已暂停 目录变化，自 2026-09-19T18:07:17.2294585+00:00，站点改名 暂停 \| WIRE_TO_GATE 在本图需求集合 210 关卡 已暂停 目录变化，自 2026-09-19T18:07:52.235782+00:00，站点已不在目录 暂停` |
...
| 210 以原名称放回目录、确认过几轮之后，等着的与新来的 WIRE_TO_GATE 需求都仍不受理，原因码 TASK_TYPE_HELD，那条暂停仍未解除（站点恢复不自动解暂停） | PASS | `second: no journey / TASK_TYPE_HELD; third: no journey / TASK_TYPE_HELD; hold fa54d74d0ac84cde97c0f3a38887203d unreleased` | `second: no journey / TASK_TYPE_HELD; third: no journey / TASK_TYPE_HELD; hold fa54d74d0ac84cde97c0f3a38887203d` |
