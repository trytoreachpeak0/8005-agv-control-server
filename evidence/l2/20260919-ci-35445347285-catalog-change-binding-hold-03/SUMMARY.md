...
| stageRoot | `C:\actions-runner\win11-01-control-server\_work\_temp\l2-35445347285-1\_stage\l2-20260919T133236108Z-slot2` |
...
| 此前已建的关卡单不被取消、不改单：同一个 UpperId 与 OrderId，仍是 CONFIRMED | PASS | `W2G-ba036b3b-05d3-4d6a-b384-ecad94483894-GATE-1 / ORDER-000002 / CONFIRMED` | `W2G-ba036b3b-05d3-4d6a-b384-ecad94483894-GATE-1 / ORDER-000002 / CONFIRMED` |
...
| 同一变化跑过多轮仍只有两条暂停；目录变化记录按站点记下改名与删除，各指向自己那条暂停 | PASS | `2 holds; 230 RENAMED, 210 REMOVED, each with a hold` | `STAGING_TO_WIRE/CATALOG_CHANGE/STATION_RENAMED, WIRE_TO_GATE/CATALOG_CHANGE/STATION_NOT_IN_CATALOG; changes: 230 RENAMED, 230 RENAMED, 210 REMOVED` |
| 看板显示两条暂停及其来源：STAGING_TO_WIRE 目录变化／站点改名，WIRE_TO_GATE 目录变化／站点已不在目录 | PASS | `STAGING_TO_WIRE: 已暂停 目录变化 站点改名；WIRE_TO_GATE: 已暂停 目录变化 站点已不在目录` | `STAGING_TO_WIRE 在本图需求集合 230 派工待送取货 已暂停 目录变化，自 2026-09-19T13:32:53.0069171+00:00，站点改名 暂停 \| WIRE_TO_GATE 在本图需求集合 210 关卡 已暂停 目录变化，自 2026-09-19T13:33:29.007201+00:00，站点已不在目录 暂停` |
