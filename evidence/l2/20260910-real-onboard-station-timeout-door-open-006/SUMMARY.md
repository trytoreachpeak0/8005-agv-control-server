...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260910T121510367Z` |
...
| 站点期限的起点已经种下——它是决策 4 那一格的计时起点 | PASS | `有值` | `SublotWaitStartedAt=2026-09-10 12:15:23.5514919+00:00` |
...
| 车载端报文逐条符合 protocol-v0.3.0 的 JSON Schema（真车载端包写进 `ProtocolInbox.RequestJson` 的每一行） | PASS | `退出码 0，校验行数 > 0，未登记违约 0` | `退出码 0：Schema conformance (protocol-v0.3.0): 38 lines, 38 distinct, 10 message types, 0 distinct violations, 0 known; schema compilation 16261 ms.` |
