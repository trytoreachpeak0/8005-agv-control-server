...
| 项 | 值 |
| --- | --- |
| runId | `20260913T070657137Z` |
| agvId | `AGV-L2-001` |
| batchId | `BATCH-3` |
| controlServerCommit | `dff5e7e18cf72021eb5dc10093a1af41dbdb9f6d` |
...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260913T070657137Z` |
...
| 第 1 轮条码录入请求被这次取消结算（#40：连接里握手读进来的旧 stop 让它漏掉） | FAIL | `SublotEntryRequested acknowledged` | `SublotEntryRequested unacknowledged` |
...
| 车载端报文逐条符合 protocol-v0.3.0 的 JSON Schema（真车载端包写进 `ProtocolInbox.RequestJson` 的每一行） | PASS | `退出码 0，校验行数 > 0，未登记违约 0` | `退出码 0：Schema conformance (protocol-v0.3.0): 16 lines, 16 distinct, 8 message types, 0 distinct violations, 0 known; schema compilation 13532 ms.` |
