...
| stageRoot | `C:\Windows\ServiceProfiles\NetworkService\AppData\Local\Temp\l2-20260912T151655176Z` |
...
| 车收到的就是服务端落库的那条命令 | PASS | `b1747174-d2b7-4a2d-9924-b1a61f3fe307` | `b1747174-d2b7-4a2d-9924-b1a61f3fe307` |
...
| 重连后补发的是同一条命令（同一个 messageId），不是新的一次下发 | PASS | `>=2 receipts of b1747174-d2b7-4a2d-9924-b1a61f3fe307` | `b1747174-d2b7-4a2d-9924-b1a61f3fe307,b1747174-d2b7-4a2d-9924-b1a61f3fe307` |
| 车只报了一次结果 | PASS | `1` | `1` |
| 一次下发只有一行激活，补报没有产生第二次激活 | PASS | `1` | `1` |
| 生效配置写了一行，就是这次激活、就是它的目标指纹 | PASS | `1 / 96ce1adc-ed1e-4ce2-aead-da22cb07a6ca / de93ca3d9eda7b619dd3ea2e8824f8592a3471b11ff723eba3dbc12ea6f69da9` | `1 / 96ce1adc-ed1e-4ce2-aead-da22cb07a6ca / de93ca3d9eda7b619dd3ea2e8824f8592a3471b11ff723eba3dbc12ea6f69da9` |
