...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260919T130403954Z` |
...
| 重连后服务端在等这次装货的结果：新代次、RecoveryRequired、PENDING_FACT_RECONCILIATION_REQUIRED，待对账 attempt 含本次装货（CV-CONNECTION-LOSS-SAFE-FINISH 的 NEVER_READY_BEFORE_RECONCILIATION） | PASS | `gen > 1 / RecoveryRequired / PENDING_FACT_RECONCILIATION_REQUIRED / pending 含 66a68776-69d6-b750-8597-6a290ab20ab5` | `断 1 条 / gen 2 / RecoveryRequired / PENDING_FACT_RECONCILIATION_REQUIRED / pendingAttempts ["66a68776-69d6-b750-8597-6a290ab20ab5"] / pendingResults [] / unsettled 66a68776-69d6-b750-8597-6a290ab20ab5 / checkpoint ACTIVE_UNLOCK_SET / activeUnlock [1]` |
...
| 同一 attempt 至多一条 OperationResult（服务端收件箱按 messageId 一行），不重复结算 | PASS | `<= 1` | `1 (66a68776-69d6-b750-8597-6a290ab20ab5 gen 2 outcome COMPLETED -> DurableAck,SessionReadiness)` |
