...
| 项 | 值 |
| --- | --- |
| runId | `20260919T091719772Z` |
| agvId | `AGV-L2-001` |
| batchId | `batch-2` |
| controlServerCommit | `34b3906d445641b779345095b38708e86296d307` |
...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260919T091719772Z` |
...
| 未结的装载指令在被持续重放（不是发一次就忘） | PASS | `> 2` | `6` |
| 重放用的是同一条命令身份（对端只有一条待答请求） | PASS | `operation:83b0056e-fee3-ac51-a874-9fbb0163a259` | `operation:83b0056e-fee3-ac51-a874-9fbb0163a259` |
