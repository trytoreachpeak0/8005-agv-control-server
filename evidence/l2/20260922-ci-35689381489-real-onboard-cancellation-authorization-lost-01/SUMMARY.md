...
| stageRoot | `C:\actions-runner\win11-01-control-server-desktop\_work\_temp\real-rig-35689381489-1\_stage\l2-20260922T053225633Z` |
...
| 取消完成也把车还回去：这一单 TO_PICKUP 的车辆占用已释放（VehicleOccupancyReleasedAt 有值），同一台车能再派单 | PASS | `VehicleOccupancyReleasedAt 有值` | `VehicleOccupancyReleasedAt 2026-09-22 05:33:09.9784963+00:00` |
