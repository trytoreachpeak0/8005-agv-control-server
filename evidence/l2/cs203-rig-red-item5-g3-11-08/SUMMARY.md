...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260920T184038651Z` |
...
| 站点任务类型准入冻结在卸货那次操作上：AdmissionDecisionSnapshots 里卸货那次有一行（AREA 机台站、STAGING_TO_WIRE、放行），装货那次没有（推翻 I6，准入跟着 AREA 端那条腿走） | FAIL | `卸货 1 行 N1-3_N1-7/STAGING_TO_WIRE/放行 / 装货 0 行` | `卸货 0 行 / 装货 0 行` |
