...
失败原因：Timed out after 120s waiting for: the second demand joined the journey already under way. Last observed: 1

## 身份

| 项 | 值 |
| --- | --- |
| runId | `20260920T091658009Z` |
| agvId | `AGV-L2-001` |
| batchId | `unspecified` |
...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260920T091658009Z` |
