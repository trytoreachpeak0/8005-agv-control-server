...
失败原因：Timed out after 120s waiting for: the demand was refused because the onboard facts are not readable. Last observed: "ACCEPTED"

## 身份

| 项 | 值 |
| --- | --- |
| runId | `20260903T102254284Z` |
| agvId | `AGV-L2-001` |
| clockSkewMs | `100` |
...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260903T102254284Z` |
