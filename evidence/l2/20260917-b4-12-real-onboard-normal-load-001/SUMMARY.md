...
| 项 | 值 |
| --- | --- |
| runId | `20260917T075851715Z` |
| agvId | `AGV-L2-001` |
| batchId | `batch-4` |
| controlServerCommit | `03ec8a8c8cb3f45098de38b7ffb6c4a9d6f33d08` |
| onboardHmiCommit | `08bcf7dd4fb69f7cbd35f4294165649838502821` |
...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260917T075851715Z` |
...
| UIA 录入的 sublot 经真车载端以 KEYBOARD 方式提交到服务端 | PASS | `L2-SUBLOT-20260917T075851715Z / KEYBOARD / L2-OPERATOR` | `L2-SUBLOT-20260917T075851715Z / KEYBOARD / L2-OPERATOR` |
...
| 装载操作提交（Committed），且记的是 UIA 录进去的那个 sublot | PASS | `Committed / L2-SUBLOT-20260917T075851715Z` | `Committed / L2-SUBLOT-20260917T075851715Z` |
