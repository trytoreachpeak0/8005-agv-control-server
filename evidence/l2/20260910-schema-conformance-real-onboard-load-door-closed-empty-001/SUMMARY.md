...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260910T111033039Z` |
...
| 全程只有一个 attempt，最终 Committed——重开不新建操作 | PASS | `Committed / 9216da2b-db71-6d54-8471-20b6036a5437` | `Committed / 9216da2b-db71-6d54-8471-20b6036a5437` |
| 整趟只发了一份 OperationResult，就是最后成功的那一份 | PASS | `1` | `1` |
| 需求从头到尾没有被判 RecoveryRequired | PASS | `Accepted` | `Accepted` |
| 车载端报文逐条符合 protocol-v0.3.0 的 JSON Schema（真车载端包写进 `ProtocolInbox.RequestJson` 的每一行） | PASS | `退出码 0，校验行数 > 0，未登记违约 0` | `退出码 0：Schema conformance (protocol-v0.3.0): 60 lines, 60 distinct, 11 message types, 0 distinct violations, 0 known; schema compilation 16935 ms.` |
