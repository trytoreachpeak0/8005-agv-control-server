...
| stageRoot | `C:\actions-runner\win11-01-control-server\_work\_temp\l2-35699901251-1\_stage\l2-20260922T073434651Z-slot1` |
...
| 需求戊（REAR 2 花篮）追加进了这趟旅程：VEHICLE_FULL 在离开最后一个装货站之前仍接追加；追加时 11 号站的停靠还没完成 | PASS | `joined journey:81326362-51f3-40d6-b63b-da1166b142b5 / station-11 stop still open` | `joined journey:81326362-51f3-40d6-b63b-da1166b142b5 (AwaitingStationDeparture VEHICLE_FULL) / PENDING` |
| 需求戊是被受理的：积压行上有受理时刻 | PASS | `accepted` | `ACCEPTED accepted=2026-09-22 07:36:01.3281688+00:00` |
