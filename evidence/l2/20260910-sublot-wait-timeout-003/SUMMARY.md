...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260910T090012719Z` |
...
| 等待起点被单独记下来，不是复用 UpdatedAt | PASS | `有值` | `SublotWaitStartedAt=2026-09-10 09:00:25.9727357+00:00` |
...
| 车辆调度租约已释放 | PASS | `已释放` | `ReleasedAt=2026-09-10 09:00:35.9755937+00:00` |
| 那条没人回答的条码录入请求被结算了 | PASS | `已结算` | `AcknowledgedAt=2026-09-10 09:00:35.9755937+00:00` |
| 按业务键写下了永久取消抑制 | PASS | `1 条 / CANCELLED_BY_STATION_TIMEOUT` | `1 条 / CANCELLED_BY_STATION_TIMEOUT / key=L2-SUBLOT-20260910T090012719Z-A\|WIRE_TO_GATE` |
