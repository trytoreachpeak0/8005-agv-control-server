...
失败原因：Timed out after 120s waiting for: the server received LoadCompensationResult, or rejected the compensation request. Last observed: (nothing)

## 身份

| 项 | 值 |
| --- | --- |
| runId | `20260918T162131985Z` |
| agvId | `AGV-L2-001` |
| batchId | `batch-2` |
...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260918T162131985Z` |
