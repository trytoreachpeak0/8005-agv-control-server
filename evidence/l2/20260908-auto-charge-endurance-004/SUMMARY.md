...
失败原因：Timed out after 120s waiting for: the second journey loaded and left for the gate. Last observed: "AwaitingSublot"

## 身份

| 项 | 值 |
| --- | --- |
| runId | `20260907T182233409Z` |
| agvId | `AGV-L2-001` |
| controlServerCommit | `2b62ebc8ca03a99ea7ac05b2b1ee7dcdaed07f03` |
| rig | `SyntheticOnboard` |
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260907T182233409Z` |
