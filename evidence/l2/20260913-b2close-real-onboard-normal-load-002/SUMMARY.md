...
| 项 | 值 |
| --- | --- |
| runId | `20260913T090011136Z` |
| agvId | `AGV-L2-001` |
| batchId | `batch-2` |
| controlServerCommit | `33e7bde39a372e7491aba2ef2559a20820815c21` |
...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260913T090011136Z` |
...
| UIA 录入的 sublot 经真车载端以 KEYBOARD 方式提交到服务端 | PASS | `L2-SUBLOT-20260913T090011136Z / KEYBOARD / L2-OPERATOR` | `L2-SUBLOT-20260913T090011136Z / KEYBOARD / L2-OPERATOR` |
...
| 装载操作提交（Committed），且记的是 UIA 录进去的那个 sublot | PASS | `Committed / L2-SUBLOT-20260913T090011136Z` | `Committed / L2-SUBLOT-20260913T090011136Z` |
