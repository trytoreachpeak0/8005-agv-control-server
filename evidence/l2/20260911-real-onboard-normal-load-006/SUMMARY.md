...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260911T031240648Z` |
...
| UIA 录入的 sublot 经真车载端以 KEYBOARD 方式提交到服务端 | PASS | `L2-SUBLOT-20260911T031240648Z / KEYBOARD / L2-OPERATOR` | `L2-SUBLOT-20260911T031240648Z / KEYBOARD / L2-OPERATOR` |
...
| 装载操作提交（Committed），且记的是 UIA 录进去的那个 sublot | PASS | `Committed / L2-SUBLOT-20260911T031240648Z` | `Committed / L2-SUBLOT-20260911T031240648Z` |
...
| 车载端报文逐条符合 protocol-v0.3.0 的 JSON Schema（真车载端包写进 `ProtocolInbox.RequestJson` 的每一行） | PASS | `退出码 0，校验行数 > 0，未登记违约 0` | `退出码 0：Schema conformance (protocol-v0.3.0): 34 lines, 34 distinct, 11 message types, 0 distinct violations, 0 known; schema compilation 19187 ms.` |
