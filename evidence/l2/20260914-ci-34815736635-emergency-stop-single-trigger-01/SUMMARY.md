...
| 项 | 值 |
| --- | --- |
| runId | `20260914T073854561Z` |
| agvId | `AGV-L2-001` |
| batchId | `batch-2` |
| controlServerCommit | `7327ef3adaf6b6ae053cccbf274cb12eb01fcc04` |
...
| stageRoot | `C:\Windows\ServiceProfiles\NetworkService\AppData\Local\Temp\l2-20260914T073854561Z` |
...
| 故障事实停在 SuspectedBlocked，证据码 VEHICLE_ORDER_FAILED，并记下了升级时刻 | PASS | `SuspectedBlocked / VEHICLE_ORDER_FAILED / 有升级时刻` | `SuspectedBlocked / VEHICLE_ORDER_FAILED / 2026-09-14 07:39:22.7674836+00:00` |
