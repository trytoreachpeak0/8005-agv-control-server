...
| 项 | 值 |
| --- | --- |
| runId | `20260911T081924653Z` |
| agvId | `AGV-L2-001` |
| batchId | `BATCH-3` |
| controlServerCommit | `813af005c828389edc988de665c7dbd2f379dba9` |
...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260911T081924653Z` |
...
| 停靠 2：补偿对账之后旅程自己离开这一站、去停靠 3，不需要再按任何按钮 | FAIL | `3/*（离开停靠 2）` | `2/Blocked / CANCELLED_BY_LOAD_COMPENSATION` |
...
| 补偿对账之后服务端会话回到 Ready（#46） | PASS | `Ready / READY` | `Ready / READY` |
| 车载端报文逐条符合 protocol-v0.3.0 的 JSON Schema（真车载端包写进 `ProtocolInbox.RequestJson` 的每一行） | PASS | `退出码 0，校验行数 > 0，未登记违约 0` | `退出码 0：Schema conformance (protocol-v0.3.0): 81 lines, 81 distinct, 15 message types, 0 distinct violations, 0 known; schema compilation 22056 ms.` |
