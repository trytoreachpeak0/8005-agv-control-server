...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260920T183609523Z` |
...
| 补偿依托恢复会话授权：工作流挂在这次打开的恢复会话上，命令就是工作流绑定的那一条，指向同一会话、同一尝试、同一仓位（AUTHORIZE_COMPENSATION_AGAINST_RECOVERY_SESSION） | PASS | `会话 09cb7ea3-dffc-a758-a8cf-8bba6a2476c9 / 命令 = 工作流绑定 / attempt 1b4707fe-1a19-f65e-a966-f7c45802578c / 仓 1` | `会话 09cb7ea3-dffc-a758-a8cf-8bba6a2476c9 / 命令 819e6b3a-6514-ea59-a508-7bd88f887358 vs 绑定 819e6b3a-6514-ea59-a508-7bd88f887358 / attempt 1b4707fe-1a19-f65e-a966-f7c45802578c / 仓 1` |
...
| 补偿收敛之后车辆放出来了：这条需求的 TO_PICKUP 单车辆占用已释放，同一台车在 60 秒内接了下一单（旅程到 AwaitingPickupArrival，不是 Blocked/VEHICLE_OCCUPANCY_CONFLICT；control-server#131） | FAIL | `TO_PICKUP 占用已释放 / 下一单 AwaitingPickupArrival on AGV-L2-001，TO_PICKUP 意图 CONFIRMED，没有停摆原因码` | `VehicleOccupancyReleasedAt='2026-09-20 18:36:37.5809938+00:00' / 下一单 Blocked/VEHICLE_OCCUPANCY_CONFLICT TO_PICKUP=CONFIRMED on AGV-L2-001` |
