...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260921T063821591Z` |
...
| 判据 | 结论 | 期望 | 实际 |
| --- | --- | --- | --- |
| 需求甲装完、FRONT 已无空仓，但 REAR 还空着：车进入持货等单（CARGO_HOLDING_WAIT），不是 VEHICLE_FULL | PASS | `CARGO_HOLDING_WAIT, started` | `AwaitingStationDeparture CARGO_HOLDING_WAIT, started '2026-09-21 06:39:12.8041886+00:00'` |
| 需求乙追加进了持货等单的这辆车（同一趟旅程） | PASS | `journey:29c56b2d-daf1-43bb-b73a-2b80fe664217` | `journey:29c56b2d-daf1-43bb-b73a-2b80fe664217` |
| 需求乙装完、REAR 还有两个空仓：仍是 CARGO_HOLDING_WAIT，起算点没有因为新停靠重置 | PASS | `CARGO_HOLDING_WAIT, started 2026-09-21 06:39:12.8041886+00:00` | `CARGO_HOLDING_WAIT (LOADED), started 2026-09-21 06:39:12.8041886+00:00` |
...
| 两个停靠上发的 WAIT 快照带同一个期限，等于第一次装货落定 + 持货超时（十分钟）；FULL 与 CLOSED 也带期限或不带由状态决定，这里只断 WAIT | PASS | `2026-09-21T06:49:12.8041886+00:00` | `2026-09-21T06:49:12.8041886+00:00` |
