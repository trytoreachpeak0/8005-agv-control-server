...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260922T151921041Z` |
...
| 上限为 0：装完到关卡腿建单不超过 25 秒（站点等待 10 秒；持货的话至少 40 秒） | PASS | `<= 25 s` | `10.4 s` |
...
| 上限未配置：装完到关卡腿建单不超过 25 秒（站点等待 10 秒；持货的话至少 40 秒） | PASS | `<= 25 s` | `10.3 s` |
