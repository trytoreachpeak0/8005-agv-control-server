...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260922T153452677Z` |
...
| 只在收到 ALL_EMPTY 结果之后终结：取消工作流无 attempt、仓集合为空、收下的正是车报的那条结果并已收敛；需求 Cancelled、旅程以 CANCELLED_BY_OPERATOR 收尾，车辆租约的释放时刻不早于服务端收到结果（TERMINATE_ONLY_ON_ALL_EMPTY_RESULT） | PASS | `LOAD_CANCELLATION / attempt= / [] / 收下 cdce3e19-fc28-e358-af9d-3a2cbd0058ce / Reconciled；Cancelled / Completed/CANCELLED_BY_OPERATOR / 释放 >= 2026-09-22T15:35:34.2706309+00:00` | `LOAD_CANCELLATION / attempt= / [] / 收下 cdce3e19-fc28-e358-af9d-3a2cbd0058ce / Reconciled；Cancelled / Completed/CANCELLED_BY_OPERATOR / 释放 2026-09-22T15:35:34.3492570+00:00` |
