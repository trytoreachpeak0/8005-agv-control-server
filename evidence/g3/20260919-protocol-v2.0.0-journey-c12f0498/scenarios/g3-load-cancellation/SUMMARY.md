...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260918T174635565Z` |
...
| 取消结算之后车辆放出来了：这条需求的 TO_PICKUP 单车辆占用已释放，同一台车在 60 秒内接了下一单（旅程到 AwaitingPickupArrival，不是 Blocked/VEHICLE_OCCUPANCY_CONFLICT；control-server#131） | PASS | `TO_PICKUP 占用已释放 / 下一单 AwaitingPickupArrival on AGV-L2-001` | `VehicleOccupancyReleasedAt='2026-09-18 17:47:00.9759827+00:00' / 下一单 AwaitingPickupArrival/ on AGV-L2-001` |
