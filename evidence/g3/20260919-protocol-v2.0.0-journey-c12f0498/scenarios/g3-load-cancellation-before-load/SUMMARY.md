...
| 只在收到 ALL_EMPTY 结果之后终结：取消工作流无 attempt、仓集合为空、收下的正是车报的那条结果并已收敛；需求 Cancelled、旅程以 CANCELLED_BY_OPERATOR 收尾，车辆租约的释放时刻不早于服务端收到结果（TERMINATE_ONLY_ON_ALL_EMPTY_RESULT） | PASS | `LOAD_CANCELLATION / attempt= / [] / 收下 09911841-2a2b-aa51-b68b-ca54fdd2c5a1 / Reconciled；Cancelled / Completed/CANCELLED_BY_OPERATOR / 释放 >= 2026-09-18T17:48:58.2643244+00:00` | `LOAD_CANCELLATION / attempt= / [] / 收下 09911841-2a2b-aa51-b68b-ca54fdd2c5a1 / Reconciled；Cancelled / Completed/CANCELLED_BY_OPERATOR / 释放 2026-09-18T17:48:58.3201458+00:00` |
