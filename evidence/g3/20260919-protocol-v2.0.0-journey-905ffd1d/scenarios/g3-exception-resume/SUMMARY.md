...
| 车载端如实报未知并从日志补发：结果 overallOutcome 为 UNKNOWN；重启后的报告列出未结清尝试与这份结果；补发载荷与第一份逐字段相同（REPORT_UNKNOWN_AS_UNKNOWN / REPLAY_RESULT_ON_RECONNECT） | PASS | `UNKNOWN / unsettled=1d57ed32-401e-ec5b-9848-b201ddbf0a67 / pendingResults 含该结果 / 载荷相同` | `UNKNOWN / unsettled=1d57ed32-401e-ec5b-9848-b201ddbf0a67 / pendingResults 1 条、含该结果 1 / 载荷相同=True` |
...
| 恢复会话只为已验证的管理员打开：会话记下车上配置的管理员与 MAINTENANCE_ADMINISTRATOR 角色，范围是这条需求与装载仓（OPEN_RECOVERY_SESSION_FOR_VERIFIED_ADMINISTRATOR） | PASS | `管理员 L2-OPERATOR / MAINTENANCE_ADMINISTRATOR / 200857b7-5bfb-4a30-8819-3311b49642e4 / 1` | `L2-OPERATOR / MAINTENANCE_ADMINISTRATOR / 200857b7-5bfb-4a30-8819-3311b49642e4 / [1]` |
| 只恢复授权的范围：恢复命令指向原尝试、原仓位与已证实的检查点；恢复之后车载端只重开了这个仓，且只开一次（AUTHORIZE_RESUME_SCOPE / RESUME_ONLY_AUTHORIZED_SCOPE / forbidden expanded-active-unlock-set） | PASS | `attempt 1d57ed32-401e-ec5b-9848-b201ddbf0a67 / 仓 1 / 已证实检查点 / 恢复后开锁 1 次、仓 1` | `attempt 1d57ed32-401e-ec5b-9848-b201ddbf0a67 / 仓 1 / SAFE_FINISH_REACHED / 恢复后开锁 1 次、仓 1` |
