...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260918T160531403Z` |
...
| 判据 | 结论 | 期望 | 实际 |
| --- | --- | --- | --- |
| 未到达：车载端没有给出「强制机械恢复」入口 | FAIL | `(reached)` | `(not reached) 车载端没有给出「强制机械恢复」入口` |
| 未到达：车载端没有给出「强制机械恢复」入口 | FAIL | `(reached)` | `(not reached) 车载端没有给出「强制机械恢复」入口` |
| 未到达：车载端没有给出「强制机械恢复」入口 | FAIL | `(reached)` | `(not reached) 车载端没有给出「强制机械恢复」入口` |
| 未到达：车载端没有给出「强制机械恢复」入口 | FAIL | `(reached)` | `(not reached) 车载端没有给出「强制机械恢复」入口` |
| 未到达：车载端没有给出「强制机械恢复」入口 | FAIL | `(reached)` | `(not reached) 车载端没有给出「强制机械恢复」入口` |
