...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260918T155814736Z` |
...
| 车载端如实报未知并从日志补发：结果 overallOutcome 为 UNKNOWN；重启后的报告把这次操作列为未结清、把这份结果列进 pendingResults；补发的载荷与第一份逐字段相同（REPORT_UNKNOWN_AS_UNKNOWN / REPLAY_RESULT_ON_RECONNECT） | PASS | `UNKNOWN / unsettled=b42bc42a-ba71-b351-b936-48da69ff2683 / pendingResults 含该结果 / 载荷相同` | `UNKNOWN / unsettled=b42bc42a-ba71-b351-b936-48da69ff2683 / pendingResults 1 条、含该结果 1 / 载荷相同=True` |
