...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260918T155543983Z` |
...
| 只在收到 ALL_EMPTY 结果之后终结：取消工作流无 attempt、仓集合为空、收下的正是车报的那条结果并已收敛；需求 Cancelled、旅程以 CANCELLED_BY_OPERATOR 收尾，车辆租约的释放时刻不早于服务端收到结果（TERMINATE_ONLY_ON_ALL_EMPTY_RESULT） | PASS | `LOAD_CANCELLATION / attempt= / [] / 收下 ebb9b0c4-e827-3451-a5cf-52a3af31e29f / Reconciled；Cancelled / Completed/CANCELLED_BY_OPERATOR / 释放 >= 2026-09-18T15:56:11.1549987+00:00` | `LOAD_CANCELLATION / attempt= / [] / 收下 ebb9b0c4-e827-3451-a5cf-52a3af31e29f / Reconciled；Cancelled / Completed/CANCELLED_BY_OPERATOR / 释放 2026-09-18T15:56:11.2122652+00:00` |
