...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260919T134731189Z` |
...
| 起终点没有互换：旅程记下的起点是派工待送站、终点是 AREA 机台，只有一行、路线证据非空；RIoT 上第一张单开往派工待送站（NEVER_SWAP_ORIGIN_AND_DESTINATION；车出发前判，第二张单的目的站在 G3-11-06） | PASS | `派工待送/230 → N1-3_N1-7/12 / 第一张单 → 230` | `派工待送/230 → N1-3_N1-7/12 / 第一张单 → 230` |
