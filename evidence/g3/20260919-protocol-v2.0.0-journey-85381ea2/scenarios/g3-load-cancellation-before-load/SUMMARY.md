...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260919T134049682Z` |
...
| 只在收到 ALL_EMPTY 结果之后终结：取消工作流无 attempt、仓集合为空、收下的正是车报的那条结果并已收敛；需求 Cancelled、旅程以 CANCELLED_BY_OPERATOR 收尾，车辆租约的释放时刻不早于服务端收到结果（TERMINATE_ONLY_ON_ALL_EMPTY_RESULT） | PASS | `LOAD_CANCELLATION / attempt= / [] / 收下 0c559deb-133b-c05b-96d6-89a4a2f0eeca / Reconciled；Cancelled / Completed/CANCELLED_BY_OPERATOR / 释放 >= 2026-09-19T13:41:09.9158239+00:00` | `LOAD_CANCELLATION / attempt= / [] / 收下 0c559deb-133b-c05b-96d6-89a4a2f0eeca / Reconciled；Cancelled / Completed/CANCELLED_BY_OPERATOR / 释放 2026-09-19T13:41:09.9586598+00:00` |
