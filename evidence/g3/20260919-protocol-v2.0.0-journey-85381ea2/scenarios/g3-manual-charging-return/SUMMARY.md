...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260919T134559658Z` |
...
| 判据 | 结论 | 期望 | 实际 |
| --- | --- | --- | --- |
| 消息顺序与向量一致：每次申请 ManualChargingReturnToServiceRequested 都得到一份关联到它的 ManualChargingReturnToServiceResult，两次申请请求号不同（CV-MANUAL-CHARGING-RETURN orderedExpectedMessages） | PASS | `申请 2 / 关联应答 2 / 请求号不同` | `申请 2 / 关联应答 2 / 请求号 aaa2dfc3-701a-41d9-b7d4-ad5053673503, 2b1102fe-a6ed-4fef-b6a0-6cf180bcc28c` |
