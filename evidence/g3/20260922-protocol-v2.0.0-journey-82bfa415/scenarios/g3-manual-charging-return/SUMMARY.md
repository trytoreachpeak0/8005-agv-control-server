...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260922T075017435Z` |
...
| 判据 | 结论 | 期望 | 实际 |
| --- | --- | --- | --- |
| 消息顺序与向量一致：每次申请 ManualChargingReturnToServiceRequested 都得到一份关联到它的 ManualChargingReturnToServiceResult，两次申请请求号不同（CV-MANUAL-CHARGING-RETURN orderedExpectedMessages） | PASS | `申请 2 / 关联应答 2 / 请求号不同` | `申请 2 / 关联应答 2 / 请求号 b8769908-e0f8-4bcd-86dc-8d7d3efb1a16, 74c8dc78-3875-44db-91b0-d1772edfd8d7` |
