...
| stageRoot | `C:\Users\szy\AppData\Local\Temp\l2-20260922T052947861Z` |
...
| 车载端如实报未知并从日志补发：结果 overallOutcome 为 UNKNOWN；重启后的报告把这次操作列为未结清、把这份结果列进 pendingResults；补发的载荷与第一份逐字段相同（REPORT_UNKNOWN_AS_UNKNOWN / REPLAY_RESULT_ON_RECONNECT） | PASS | `UNKNOWN / unsettled=71447ba7-5100-1457-b267-bc284f1b828f / pendingResults 含该结果 / 载荷相同` | `UNKNOWN / unsettled=71447ba7-5100-1457-b267-bc284f1b828f / pendingResults 1 条、含该结果 1 / 载荷相同=True` |
